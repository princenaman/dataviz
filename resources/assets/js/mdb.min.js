function dropdownEffectData(t) {
	var e = null
	  ...
	  , o = $(".dropdown-menu", t)
	  , r = i.parents("ul.nav");
	return r.height > 0 && (e = r.data("dropdown-in") || null,
...
function get_social_counts() {
	...
	$.ajax({
		...
		success: function(t) {
			...
			r > 0 ? $("#facebook-span").text(r) : $("#facebook-span").hide(),
			$("#twitter-span").html(a),
			$("#gplus-span").html(s)
		}
	})
...
if (function(t, e) {
	...
	function o(t, e, n) {
		...
		}) : wt.test(e) ? ft.filter(e, t, n) : (e = ft.filter(e, t),
	...
	function f(t, e, n) {
		...
		if (void 0 === n && 1 === t.nodeType)
			if (i = "data-" + e.replace(Lt, "-$&").toLowerCase(),
	...
	function g(t) {
		...
		return o ? o : (e = n.body.appendChild(n.createElement(i)),
		o = ft.css(e, "display"),
	...
	function m(t, e) {
		for (var n, i, o = [], r = 0, a = t.length; r < a; r++)
			...
			e ? ("none" === n && (o[r] = It.get(i, "display") || null,
			o[r] || (i.style.display = "")),
			"" === i.style.display && Rt(i) && (o[r] = g(i))) : "none" !== n && (o[r] = "none",
			It.set(i, "display", n)));
		for (r = 0; r < a; r++)
	...
	function b(t, e, n, i, o) {
		for (var r, a, s, l, c, u, h = e.createDocumentFragment(), d = [], f = 0, p = t.length; f < p; f++)
			if ((r = t[f]) || 0 === r)
				if ("object" === ft.type(r))
					ft.merge(d, r.nodeType ? [r] : r);
				else if (qt.test(r)) {
					for (a = a || h.appendChild(e.createElement("div")),
					s = (zt.exec(r) || ["", ""])[1].toLowerCase(),
					l = Bt[s] || Bt._default,
					a.innerHTML = l[1] + ft.htmlPrefilter(r) + l[2],
					u = l[0]; u--; )
						a = a.lastChild;
					ft.merge(d, a.childNodes),
					a = h.firstChild,
					a.textContent = ""
				} else
		...
		for (h.textContent = "",
		f = 0; r = d[f++]; )
			if (i && ft.inArray(r, i) > -1)
				o && o.push(r);
			else if (c = ft.contains(r.ownerDocument, r),
			a = v(h.appendChild(r), "script"),
			c && y(a),
			n)
				for (u = 0; r = a[u++]; )
		...
		if (1 === e.nodeType) {
			...
			c = r.events)) {
				...
				for (o in c)
					for (n = 0,
					i = c[o].length; n < i; n++)
						ft.event.add(e, o, c[o][n])
			}
			Dt.hasData(t) && (s = Dt.access(t),
			l = ft.extend({}, s),
			Dt.set(e, l))
		}
	}
	...
	function P(t, e, i, o) {
		...
		if (g || d > 1 && "string" == typeof p && !dt.checkClone && Gt.test(p))
			return t.each(function(n) {
				var r = t.eq(n);
				g && (e[0] = p.call(this, n, r.html())),
				P(r, e, i, o)
			});
		if (d && (r = b(e, t[0].ownerDocument, !1, t, o),
		a = r.firstChild,
		1 === r.childNodes.length && (r = a),
		a || o)) {
			for (s = ft.map(v(r, "script"), E),
			l = s.length; h < d; h++)
				c = r,
				h !== f && (c = ft.clone(c, !0, !0),
				l && ft.merge(s, v(c, "script"))),
				i.call(t[h], c, h);
			if (l)
				...
				h = 0; h < l; h++)
					c = s[h],
					Vt.test(c.type || "") && !It.access(c, "globalEval") && ft.contains(u, c) && (c.src ? ft._evalUrl && ft._evalUrl(c.src) : n(c.textContent.replace(Kt, ""), u))
		}
		return t
	}
	function I(t, e, n) {
		for (var i, o = e ? ft.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
			...
			i.parentNode && (n && ft.contains(i.ownerDocument, i) && y(v(i, "script")),
	...
	function D(t, e, n) {
		...
		"" !== a || ft.contains(t.ownerDocument, t) || (a = ft.style(t, e)),
		!dt.pixelMarginRight() && te.test(a) && Jt.test(e) && (i = s.width,
		o = s.minWidth,
		r = s.maxWidth,
	...
	function N(t, e, n, i, o) {
		...
		for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
			"margin" === n && (a += ft.css(t, n + Mt[r], !0, o)),
			i ? ("content" === n && (a -= ft.css(t, "padding" + Mt[r], !0, o)),
			"margin" !== n && (a -= ft.css(t, "border" + Mt[r] + "Width", !0, o))) : (a += ft.css(t, "padding" + Mt[r], !0, o),
			"padding" !== n && (a += ft.css(t, "border" + Mt[r] + "Width", !0, o)));
		return a
	}
	function M(t, e, n) {
		...
		i <= 0 || null == i) {
			...
			te.test(i))
				return i;
			o = a && (dt.boxSizingReliable() || i === t.style[e]),
			i = parseFloat(i) || 0
		}
	...
	function q(t, e, n) {
		var i, o, r = 0, a = q.prefilters.length, s = ft.Deferred().always(function() {
			...
			if (o)
				return !1;
			for (var e = se || H(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, a = 0, l = c.tweens.length; a < l; a++)
				c.tweens[a].run(r);
			return s.notifyWith(t, [c, r, n]),
			r < 1 && l ? n : (s.resolveWith(t, [c]),
			!1)
		}, c = s.promise({
			elem: t,
			props: ft.extend({}, e),
		...
		s--); s < l; s++)
			if (null != (t = arguments[s]))
				for (e in t)
					n = a[e],
					i = t[e],
					a !== i && (c && i && (ft.isPlainObject(i) || (o = ft.isArray(i))) ? (o ? (o = !1,
					r = n && ft.isArray(n) ? n : []) : r = n && ft.isPlainObject(n) ? n : {},
					a[e] = ft.extend(c, r, i)) : void 0 !== i && (a[e] = i));
		return a
	}
	,
	ft.extend({
	...
	var gt = function(t) {
		function e(t, e, n, i) {
			...
			"string" != typeof t || !t || 1 !== p && 9 !== p && 11 !== p)
				return n;
			if (!i && ((e ? e.ownerDocument || e : H) !== D && I(e),
			e = e || D,
			L)) {
				if (11 !== p && (l = gt.exec(t)))
					if (o = l[1]) {
						if (9 === p) {
							...
							if (a.id === o)
								return n.push(a),
								n
						} else if (f && (a = f.getElementById(o)) && R(e, a) && a.id === o)
							return n.push(a),
							n
					} else {
						if (l[2])
				...
				if (w.qsa && !q[t + " "] && (!F || !F.test(t))) {
					if (1 !== p)
						...
						for ((s = e.getAttribute("id")) ? s = s.replace(bt, wt) : e.setAttribute("id", s = W),
						u = S(t),
						r = u.length; r--; )
							u[r] = "#" + s + " " + h(u[r]);
						d = u.join(","),
						f = mt.test(t) && c(e.parentNode) || e
					}
					if (d)
						try {
			...
			i(function(i, a, s, l) {
				...
				if (i) {
					if (r || t) {
						...
						for (u = b.length; u--; )
							(h = b[u]) && (c = r ? K(i, h) : d[u]) > -1 && (i[c] = !(a[c] = h))
					}
				} else
		...
		try {
			G.apply($ = Z.call(H.childNodes), H.childNodes),
		...
		I = e.setDocument = function(t) {
			...
			O = D.documentElement,
			L = !T(D),
			H !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xt, !1) : n.attachEvent && n.attachEvent("onunload", xt)),
			...
			w.getElementsByClassName = pt.test(D.getElementsByClassName),
			w.getById = o(function(t) {
				return O.appendChild(t).id = W,
			...
			N = [],
			F = [],
			(w.qsa = pt.test(D.querySelectorAll)) && (o(function(t) {
				O.appendChild(t).innerHTML = "<a id='" + W + "'></a><select id='" + W + "-\r\\' msallowcapture=''><option selected=''></option></select>",
				t.querySelectorAll("[msallowcapture^='']").length && F.push("[*^$]=" + tt + "*(?:''|\"\")"),
				t.querySelectorAll("[selected]").length || F.push("\\[" + tt + "*(?:value|" + J + ")"),
				t.querySelectorAll("[id~=" + W + "-]").length || F.push("~="),
				t.querySelectorAll(":checked").length || F.push(":checked"),
				t.querySelectorAll("a#" + W + "+*").length || F.push(".#.+[+~]")
			}),
			o(function(t) {
			...
			e = pt.test(O.compareDocumentPosition),
			R = e || pt.test(O.contains) ? function(t, e) {
			...
			Y = e ? function(t, e) {
				...
				1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === D || t.ownerDocument === H && R(H, t) ? -1 : e === D || e.ownerDocument === H && R(H, e) ? 1 : _ ? K(_, t) - K(_, e) : 0 : 4 & n ? -1 : 1)
			}
			: function(t, e) {
				if (t === e)
					return P = !0,
				...
				if (!o || !r)
					return t === D ? -1 : e === D ? 1 : o ? -1 : r ? 1 : _ ? K(_, t) - K(_, e) : 0;
				if (o === r)
					return a(t, e);
		...
		e.matchesSelector = function(t, n) {
			if ((t.ownerDocument || t) !== D && I(t),
			n = n.replace(lt, "='$1']"),
			w.matchesSelector && L && !q[n + " "] && (!N || !N.test(n)) && (!F || !F.test(n)))
				try {
					var i = M.call(t, n);
		...
		e.contains = function(t, e) {
			return (t.ownerDocument || t) !== D && I(t),
			R(t, e)
		}
		,
		e.attr = function(t, e) {
				...
				CHILD: function(t, e, n, i, o) {
					...
					: function(e, n, l) {
						...
						if (m) {
							...
							b = f),
							b === !1)
								for (; (d = ++f && d && d[g] || (b = f = 0) || p.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && (h = d[W] || (d[W] = {}),
								u = h[d.uniqueID] || (h[d.uniqueID] = {}),
								u[t] = [j, b]),
								d !== e)); )
									;
		...
		S = e.tokenize = function(t, n) {
			...
			c = x.preFilter; s; ) {
				...
				s = s.slice(i.length));
				for (a in x.filter)
					!(o = ht[a].exec(s)) || c[a] && !(o = c[a](o)) || (i = o.shift(),
					r.push({
						value: i,
						type: a,
						matches: o
		...
		k = e.select = function(t, e, n, i) {
			...
			1 === d.length) {
				...
				r.length > 2 && "ID" === (a = r[0]).type && 9 === e.nodeType && L && x.relative[r[1].type]) {
					if (!(e = (x.find.ID(a.matches[0].replace(vt, yt), e) || [])[0]))
						return n;
					u && (e = e.parentNode),
			...
			return (u || E(t, d))(i, e, !L, n, !e || mt.test(t) && c(e.parentNode) || e),
			n
		}
		,
	...
	ft.find = gt,
	ft.expr = gt.selectors,
	ft.expr[":"] = ft.expr.pseudos,
	ft.uniqueSort = ft.unique = gt.uniqueSort,
	ft.text = gt.getText,
	ft.isXMLDoc = gt.isXML,
	ft.contains = gt.contains,
	ft.escapeSelector = gt.escape;
	...
	ft.each({
		...
		ft.fn[t] = function(n, i) {
			...
			this.length > 1 && (St[t] || ft.uniqueSort(o),
			Tt.test(t) && o.reverse()),
			this.pushStack(o)
		}
	});
		...
		var e, n, i, o, r = [], s = [], l = -1, c = function() {
			...
			remove: function() {
				return ft.each(arguments, function(t, e) {
					for (var n; (n = ft.inArray(e, r, n)) > -1; )
						r.splice(n, 1),
						n <= l && l--
				}),
				this
	...
	ft.extend({
			  ...
			  , o = {
				...
				then: function(e, i, o) {
						...
						return function() {
							var c = this
							  ...
							  , h = function() {
								var t, h;
								if (!(e < a)) {
									if ((t = i.apply(c, u)) === n.promise())
										throw new TypeError("Thenable self-resolution");
									h = t && ("object" == typeof t || "function" == typeof t) && t.then,
									ft.isFunction(h) ? o ? h.call(t, r(a, n, s, o), r(a, n, l, o)) : (a++,
									h.call(t, r(a, n, s, o), r(a, n, l, o), r(a, n, s, n.notifyWith))) : (i !== s && (c = void 0,
									u = [t]),
									(o || n.resolveWith)(c, u))
								}
							}
					...
					return ft.Deferred(function(t) {
						n[0][3].add(r(0, t, ft.isFunction(o) ? o : s, t.notifyWith)),
						n[1][3].add(r(0, t, ft.isFunction(e) ? e : s)),
		...
		when: function(t) {
			...
			if (e <= 1 && (c(t, r.done(a(n)).resolve, r.reject),
			"pending" === r.state() || ft.isFunction(o[n] && o[n].then)))
				return r.then();
			for (; n--; )
				c(o[n], a(n), r.reject);
			return r.promise()
	...
	ft.extend({
		...
		ready: function(t) {
			...
			t !== !0 && --ft.readyWait > 0 || At.resolveWith(et, [ft]))
		}
	}),
	ft.ready.then = At.then,
	"complete" === et.readyState || "loading" !== et.readyState && !et.documentElement.doScroll ? t.setTimeout(ft.ready) : (et.addEventListener("DOMContentLoaded", u),
	...
	h.prototype = {
		...
		remove: function(t, e) {
			...
			if (void 0 !== i) {
				if (void 0 !== e) {
					ft.isArray(e) ? e = e.map(ft.camelCase) : (e = ft.camelCase(e),
	...
	ft.fn.extend({
		data: function(t, e) {
			...
			if (void 0 === t) {
				if (this.length && (o = Dt.get(r),
				1 === r.nodeType && !It.get(r, "hasDataAttrs"))) {
					for (n = a.length; n--; )
						a[n] && (i = a[n].name,
						0 === i.indexOf("data-") && (i = ft.camelCase(i.slice(5)),
						f(r, i, o[i])));
	...
	ft.extend({
		queue: function(t, e, n) {
			...
			if (t)
				return e = (e || "fx") + "queue",
				i = It.get(t, e),
				n && (!i || ft.isArray(n) ? i = It.access(t, e, ft.makeArray(n)) : i.push(n)),
				i || []
		},
	...
	ft.fn.extend({
		...
		promise: function(t, e) {
			...
			t = void 0),
			t = t || "fx"; a--; )
				(n = It.get(r[a], t + "queueHooks")) && n.empty && (i++,
				n.empty.add(s));
			return s(),
			o.promise(e)
		}
	...
	ft.event = {
		...
		add: function(t, e, n, i, o) {
			...
			if (m)
				...
				n = r.handler,
				o = r.selector),
				o && ft.find.matchesSelector(Yt, o),
				...
				c = e.length; c--; )
					...
					(d = l[f]) || (d = l[f] = [],
					d.delegateCount = 0,
					h.setup && h.setup.call(t, i, p, a) !== !1 || t.addEventListener && t.addEventListener(f, a)),
			...
			if (m && (l = m.events)) {
				...
				c = e.length; c--; )
					...
					f) {
						...
						a = r = d.length; r--; )
							u = d[r],
							!o && g !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(r, 1),
							u.selector && d.delegateCount--,
							h.remove && h.remove.call(t, u));
						a && !d.length && (h.teardown && h.teardown.call(t, p, m.handle) !== !1 || ft.removeEvent(t, f, m.handle),
						delete l[f])
					} else
						for (f in l)
		...
		dispatch: function(t) {
			...
			!u.preDispatch || u.preDispatch.call(this, s) !== !1) {
				for (a = ft.event.handlers.call(this, s, c),
				e = 0; (o = a[e++]) && !s.isPropagationStopped(); )
					...
					n = 0; (r = o.handlers[n++]) && !s.isImmediatePropagationStopped(); )
						...
						s.data = r.data,
						void 0 !== (i = ((ft.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && (s.result = i) === !1 && (s.preventDefault(),
						s.stopPropagation()));
				...
				for (; c !== this; c = c.parentNode || this)
					if (1 === c.nodeType && ("click" !== t.type || c.disabled !== !0)) {
						...
						n = 0; n < l; n++)
							i = e[n],
							o = i.selector + " ",
							void 0 === a[o] && (a[o] = i.needsContext ? ft(o, this).index(c) > -1 : ft.find(o, this, null, [c]).length),
							a[o] && r.push(i);
						r.length && s.push({
							elem: c,
							handlers: r
	...
	ft.each({
		...
		ft.event.special[t] = {
			...
			handle: function(t) {
				...
				return o && (o === i || ft.contains(i, o)) || (t.type = r.origType,
			...
			return _t(this, function(t) {
				...
				if ("string" == typeof t && !Qt.test(t) && !Bt[(zt.exec(t) || ["", ""])[1].toLowerCase()]) {
					...
					try {
						for (; n < i; n++)
							e = this[n] || {},
							1 === e.nodeType && (ft.cleanData(v(e, !1)),
							e.innerHTML = t);
						e = 0
					} catch (t) {}
				}
	...
	ft.each({
		...
		ft.fn[t] = function(t) {
			for (var n, i = [], o = ft(t), r = o.length - 1, a = 0; a <= r; a++)
	...
	ft.extend({
		...
		style: function(t, e, n, i) {
			if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
				...
				if (e = ft.cssProps[s] || (ft.cssProps[s] = L(s) || s),
				a = ft.cssHooks[e] || ft.cssHooks[s],
				void 0 === n)
					return a && "get"in a && void 0 !== (o = a.get(t, !1, i)) ? o : l[e];
				r = typeof n,
				"string" === r && (o = Nt.exec(n)) && o[1] && (n = p(t, e, o),
				r = "number"),
				null != n && n === n && ("number" === r && (n += o && o[3] || (ft.cssNumber[s] ? "" : "px")),
		...
		css: function(t, e, n, i) {
			...
			return e = ft.cssProps[s] || (ft.cssProps[s] = L(s) || s),
			a = ft.cssHooks[e] || ft.cssHooks[s],
	...
	ft.each(["height", "width"], function(t, e) {
		ft.cssHooks[e] = {
			get: function(t, n, i) {
				if (n)
					return !ne.test(ft.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? M(t, e, i) : Wt(t, ie, function() {
						return M(t, e, i)
					})
			},
			set: function(t, n, i) {
				var o, r = i && ee(t), a = i && N(t, e, i, "border-box" === ft.css(t, "boxSizing", !1, r), r);
				return a && (o = Nt.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n,
				n = ft.css(t, e)),
				F(t, n, a)
			}
		}
	...
	ft.cssHooks.marginLeft = O(dt.reliableMarginLeft, function(t, e) {
		if (e)
			return (parseFloat(D(t, "marginLeft")) || t.getBoundingClientRect().left - Wt(t, {
				marginLeft: 0
			}, function() {
	...
	ft.extend({
		attr: function(t, e, n) {
			...
			if (3 !== r && 8 !== r && 2 !== r)
				return void 0 === t.getAttribute ? ft.prop(t, e, n) : (1 === r && ft.isXMLDoc(t) || (o = ft.attrHooks[e.toLowerCase()] || (ft.expr.match.bool.test(e) ? he : void 0)),
	...
	he = {
		set: function(t, e, n) {
			return e === !1 ? ft.removeAttr(t, n) : t.setAttribute(n, n),
			n
		}
	},
		...
		toggleClass: function(t, e) {
			...
			return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ft.isFunction(t) ? this.each(function(n) {
				...
				if ("string" === n)
					...
					this.setAttribute && this.setAttribute("class", e || t === !1 ? "" : It.get(this, "__className__") || ""))
			})
		},
		hasClass: function(t) {
			var e, n, i = 0;
			...
			var e, n, i, o = this[0];
			{
				if (arguments.length)
					...
					this.each(function(n) {
						var o;
						1 === this.nodeType && (o = i ? t.call(this, n, ft(this).val()) : t,
						null == o ? o = "" : "number" == typeof o ? o += "" : ft.isArray(o) && (o = ft.map(o, function(t) {
							return null == t ? "" : t + ""
						})),
						(e = ft.valHooks[this.type] || ft.valHooks[this.nodeName.toLowerCase()]) && "set"in e && void 0 !== e.set(this, o, "value") || (this.value = o))
					});
				if (o)
					return (e = ft.valHooks[o.type] || ft.valHooks[o.nodeName.toLowerCase()]) && "get"in e && void 0 !== (n = e.get(o, "value")) ? n : (n = o.value,
			...
			select: {
				get: function(t) {
					...
					for (i = r < 0 ? l : a ? r : 0; i < l; i++)
						if (n = o[i],
						(n.selected || i === r) && !n.disabled && (!n.parentNode.disabled || !ft.nodeName(n.parentNode, "optgroup"))) {
							if (e = ft(n).val(),
							a)
								return e;
							s.push(e)
				...
				set: function(t, e) {
					for (var n, i, o = t.options, r = ft.makeArray(e), a = o.length; a--; )
						i = o[a],
						(i.selected = ft.inArray(ft.valHooks.option.get(i), r) > -1) && (n = !0);
	...
	ft.extend(ft.event, {
		trigger: function(e, n, i, o) {
			...
			if (a = s = i = i || et,
			3 !== i.nodeType && 8 !== i.nodeType && !ge.test(f + ft.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."),
			f = p.shift(),
			p.sort()),
			c = f.indexOf(":") < 0 && "on" + f,
			...
			o || !h.trigger || h.trigger.apply(i, n) !== !1)) {
				if (!o && !h.noBubble && !ft.isWindow(i)) {
					...
					ge.test(l + f) || (a = a.parentNode); a; a = a.parentNode)
						d.push(a),
						s = a;
				...
				for (r = 0; (a = d[r++]) && !e.isPropagationStopped(); )
					...
					u = (It.get(a, "events") || {})[e.type] && It.get(a, "handle"),
					u && u.apply(a, n),
					(u = c && a[c]) && u.apply && Pt(a) && (e.result = u.apply(a, n),
					e.result === !1 && e.preventDefault());
				return e.type = f,
				o || e.isDefaultPrevented() || h._default && h._default.apply(d.pop(), n) !== !1 || !Pt(i) || c && ft.isFunction(i[f]) && !ft.isWindow(i) && (s = i[c],
				s && (i[c] = null),
	...
	dt.focusin || ft.each({
		...
		ft.event.special[e] = {
			...
			teardown: function() {
				var i = this.ownerDocument || this
				  , o = It.access(i, e) - 1;
				o ? It.access(i, e, o) : (i.removeEventListener(t, n, !0),
				It.remove(i, e))
			}
		}
	});
	...
	ft.extend({
		...
		ajax: function(e, n) {
			function i(e, n, i, s) {
				...
				i && (w = Z(p, T, i)),
				w = K(p, w, T, c),
				c ? (p.ifModified && (x = T.getResponseHeader("Last-Modified"),
				x && (ft.lastModified[r] = x),
				(x = T.getResponseHeader("etag")) && (ft.etag[r] = x)),
				...
				T.status = e,
				T.statusText = (n || C) + "",
				c ? v.resolveWith(g, [d, C, T]) : v.rejectWith(g, [T, C, f]),
				T.statusCode(b),
				b = void 0,
			...
			if (v.promise(T),
			p.url = ((e || p.url || me.href) + "").replace(/^\/\//, me.protocol + "//"),
			...
			null == p.crossDomain) {
				...
				try {
					c.href = p.url,
					c.href = c.href,
					p.crossDomain = _e.protocol + "//" + _e.host != c.protocol + "//" + c.host
				} catch (t) {
					p.crossDomain = !0
				}
			}
			...
			p.hasContent = !Se.test(p.type),
			r = p.url.replace(/#.*$/, ""),
			p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(/%20/g, "+")) : (f = p.url.slice(r.length),
			p.data && (r += (ye.test(r) ? "&" : "?") + p.data,
			delete p.data),
			p.cache === !1 && (r = r.replace(/([?&])_=[^&]*/, "$1"),
			f = (ye.test(r) ? "&" : "?") + "_=" + ve++ + f),
			p.url = r + f),
			p.ifModified && (ft.lastModified[r] && T.setRequestHeader("If-Modified-Since", ft.lastModified[r]),
			ft.etag[r] && T.setRequestHeader("If-None-Match", ft.etag[r])),
			...
			if (p.beforeSend && (p.beforeSend.call(g, T, p) === !1 || u))
				return T.abort();
			if (C = "abort",
			y.add(p.complete),
			T.done(p.success),
	...
	dt.cors = !!Ie && "withCredentials"in Ie,
	dt.ajax = Ie = !!Ie,
	ft.ajaxTransport(function(e) {
		var n, i;
		if (dt.cors || Ie && !e.crossDomain)
			return {
				send: function(o, r) {
					var a, s = e.xhr();
					...
					n = function(t) {
						return function() {
							...
							"abort" === t ? s.abort() : "error" === t ? "number" != typeof s.status ? r(0, "error") : r(s.status, s.statusText) : r(Pe[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
								binary: s.response
							} : {
								text: s.responseText
	...
	ft.ajaxPrefilter("json jsonp", function(e, n, i) {
		...
		if (s || "jsonp" === e.dataTypes[0])
			return o = e.jsonpCallback = ft.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
			s ? e[s] = e[s].replace(Oe, "$1" + o) : e.jsonp !== !1 && (e.url += (ye.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
			e.converters["script json"] = function() {
				return a || ft.error(o + " was not called"),
				a[0]
			}
			,
			e.dataTypes[0] = "json",
	...
	ft.parseHTML = function(t, e, n) {
		...
		e = !1);
		var i, o, r;
		return e || (dt.createHTMLDocument ? (e = et.implementation.createHTMLDocument(""),
	...
	ft.fn.load = function(t, e, n) {
		...
		a.length > 0 && ft.ajax({
			...
			r = arguments,
			a.html(i ? ft("<div>").append(ft.parseHTML(t)).find(i) : t)
	...
	ft.offset = {
		setOffset: function(t, e, n) {
			...
			o = parseFloat(l) || 0),
			ft.isFunction(e) && (e = e.call(t, n, ft.extend({}, s))),
	...
	ft.fn.extend({
		...
		position: function() {
			if (this[0]) {
				...
				e = this.offset(),
				ft.nodeName(t[0], "html") || (i = t.offset()),
				i = {
	...
	ft.each(["top", "left"], function(t, e) {
		ft.cssHooks[e] = O(dt.pixelPosition, function(t, n) {
			if (n)
				return n = D(t, e),
				te.test(n) ? ft(t).position()[e] + "px" : n
		})
	}),
	ft.each({
		Height: "height",
		...
		ft.each({
			...
			ft.fn[i] = function(o, r) {
				...
				return _t(this, function(e, n, o) {
					...
					Math.max(e.body["scroll" + t], r["scroll" + t], e.body["offset" + t], r["offset" + t], r["client" + t])) : void 0 === o ? ft.css(e, n, s) : ft.style(e, n, o, s)
				}, e, a ? o : void 0, a)
			}
		})
	}),
...
function(t, e) {
	...
	function o(t) {
		...
		for (var i = t; i = i.parentNode; ) {
			...
			var r = o
			  ...
			  , s = r.overflowX
			  , l = r.overflowY;
			if (/(auto|scroll)/.test(a + l + s) && ("absolute" !== n || ["relative", "absolute", "fixed"].indexOf(o.position) >= 0))
				return i
		}
	...
	var C = function() {
	  ...
	  , S = function(t) {
		...
		void 0 === e && (e = t.createElement("div"),
		e.setAttribute("data-tether-id", C()),
		l(e.style, {
			top: 0,
			left: 0,
			position: "absolute"
	...
	!function() {
		var t = null
		  ...
		  , i = function i() {
			...
			void 0 !== t && m() - t < 10 || (void 0 !== n && (clearTimeout(n),
			n = null),
			t = m(),
			L(),
			e = m() - t)
	...
	var F = {
	  ...
	  , W = function(t) {
		var e = t.left
		  , n = t.top;
		return void 0 !== M[t.left] && (e = M[t.left]),
		void 0 !== M[t.top] && (n = M[t.top]),
		{
			left: e,
			top: n
		}
	  ...
	  , z = function() {
		...
		return w(t, [{
			...
			value: function() {
				...
				this.enabled = !1,
				void 0 !== this.scrollParent && this.scrollParent.removeEventListener("scroll", this.position)
			}
		}, {
			key: "destroy",
			value: function() {
			...
			value: function(t, e) {
				...
				k(function() {
					void 0 !== n._addAttachClasses && (p(n.element, n._addAttachClasses, r),
					n.options.addTargetClasses !== !1 && p(n.target, n._addAttachClasses, r),
			...
			value: function() {
				...
				if (this.enabled) {
					...
					for (var m = u.left + f.left - d.left, b = u.top + f.top - d.top, w = 0; w < x.modules.length; ++w) {
						...
						if (T === !1)
							return !1;
						void 0 !== T && "object" == typeof T && (b = T.top,
						m = T.left)
					}
					var S = {
						page: {
					  ...
					  , E = void 0;
					return document.body.scrollWidth > window.innerWidth && (E = this.cache("scrollbar-size", s),
					S.viewport.bottom -= E.height),
					document.body.scrollHeight > window.innerHeight && (E = this.cache("scrollbar-size", s),
					S.viewport.right -= E.width),
					["", "static"].indexOf(document.body.style.position) !== -1 && ["", "static"].indexOf(document.body.parentElement.style.position) !== -1 || (S.page.bottom = document.body.scrollHeight - b - l,
					S.page.right = document.body.scrollWidth - m - o),
					void 0 !== this.options.optimizations && this.options.optimizations.moveElement !== !1 && void 0 === this.targetModifier && function() {
						...
						n.right = document.body.scrollWidth - n.left - o.width + s.right,
						n.bottom = document.body.scrollHeight - n.top - o.height + s.bottom,
						S.page.top >= n.top + s.top && S.page.bottom >= n.bottom && S.page.left >= n.left + s.left && S.page.right >= n.right) {
							var l = e.scrollTop
							  , c = e.scrollLeft;
							S.offset = {
			...
			value: function(t) {
				...
				if (void 0 !== this.element.parentNode) {
					...
					var u = {
					  ...
					  , h = function(t, n) {
						if ((void 0 !== e.options.optimizations ? e.options.optimizations.gpu : null) !== !1) {
							...
							o = n.left) : (u.right = 0,
							o = -n.right),
							u[D] = "translateX(" + Math.round(o) + "px) translateY(" + Math.round(i) + "px)",
					...
					h(n.page, t.page)) : (n.viewport.top || n.viewport.bottom) && (n.viewport.left || n.viewport.right) ? (u.position = "fixed",
					h(n.viewport, t.viewport)) : void 0 !== n.offset && n.offset.top && n.offset.left ? function() {
						u.position = "absolute";
					...
					for (var o in u) {
						...
						"" !== b && "" !== y && ["top", "left", "bottom", "right"].indexOf(o) >= 0 && (b = parseFloat(b),
						y = parseFloat(y)),
						b !== y && (v = !0,
						m[o] = y)
					}
		...
		position: function(t) {
			...
			return this.options.constraints.forEach(function(t) {
				...
				if (a.indexOf(" ") >= 0) {
					...
					u = h = a;
				var w = b(e, r);
				"target" !== h && "both" !== h || (n < w[1] && "top" === v.top && (n += d,
				v.top = "bottom"),
				n + s > w[3] && "bottom" === v.top && (n -= d,
				v.top = "top")),
				"together" === h && (n < w[1] && "top" === v.top && ("bottom" === y.top ? (n += d,
				v.top = "bottom",
				n += s,
				y.top = "top") : "top" === y.top && (n += d,
				v.top = "bottom",
				n -= s,
				y.top = "bottom")),
				n + s > w[3] && "bottom" === v.top && ("top" === y.top ? (n -= d,
				v.top = "top",
				n -= s,
				y.top = "bottom") : "bottom" === y.top && (n -= d,
				v.top = "top",
				n += s,
				y.top = "top")),
				"middle" === v.top && (n + s > w[3] && "top" === y.top ? (n -= s,
				y.top = "bottom") : n < w[1] && "bottom" === y.top && (n += s,
				y.top = "top"))),
				"target" !== u && "both" !== u || (i < w[0] && "left" === v.left && (i += f,
				v.left = "right"),
				i + c > w[2] && "right" === v.left && (i -= f,
				v.left = "left")),
				"together" === u && (i < w[0] && "left" === v.left ? "right" === y.left ? (i += f,
				v.left = "right",
				i += c,
				y.left = "left") : "left" === y.left && (i += f,
				v.left = "right",
				i -= c,
				y.left = "right") : i + c > w[2] && "right" === v.left ? "left" === y.left ? (i -= f,
				v.left = "left",
				i -= c,
				y.left = "right") : "right" === y.left && (i -= f,
				v.left = "left",
				i += c,
				y.left = "left") : "center" === v.left && (i + c > w[2] && "left" === y.left ? (i -= c,
				y.left = "right") : i < w[0] && "right" === y.left && (i += c,
				y.left = "left"))),
				"element" !== h && "both" !== h || (n < w[1] && "bottom" === y.top && (n += s,
				y.top = "top"),
				n + s > w[3] && "top" === y.top && (n -= s,
				y.top = "bottom")),
				"element" !== u && "both" !== u || (i < w[0] && ("right" === y.left ? (i += c,
				y.left = "left") : "center" === y.left && (i += c / 2,
				y.left = "left")),
				i + c > w[2] && ("left" === y.left ? (i -= c,
				y.left = "right") : "center" === y.left && (i -= c / 2,
				y.left = "right"))),
				...
				n + s > w[3] && (l.indexOf("bottom") >= 0 ? (n = w[3] - s,
				x.push("bottom")) : C.push("bottom")),
				i < w[0] && (l.indexOf("left") >= 0 ? (i = w[0],
				x.push("left")) : C.push("left")),
				i + c > w[2] && (l.indexOf("right") >= 0 ? (i = w[2] - c,
	...
	x.modules.push({
		position: function(t) {
			...
			k(function() {
				e.options.addTargetClasses !== !1 && p(e.target, f, d),
				p(e.element, f, d)
			}),
			!0
		}
...
function() {
				...
				for (var r in o)
					if (o.hasOwnProperty(r)) {
						...
						if (!new RegExp(a).test(l))
							throw new Error(t.toUpperCase() + ': Option "' + r + '" provided type "' + l + '" but expected type "' + a + '".')
					}
			}
		};
		return function() {
	...
	function(t) {
		...
		t(document).on(s.CLICK_DATA_API, a.DATA_TOGGLE_CARROT, function(e) {
			e.preventDefault();
			var n = e.target;
			t(n).hasClass(r.BUTTON) || (n = t(n).closest(a.BUTTON)),
	...
	function(t) {
		  ...
		  , g = function() {
			...
			l.prototype._slide = function(e, n) {
				...
				if (!this._triggerSlideEvent(a, u).isDefaultPrevented() && o && a) {
					...
					r.supportsTransitionEnd() && t(this._element).hasClass(f.SLIDE) ? (t(a).addClass(c),
					r.reflow(a),
					t(o).addClass(l),
					t(a).addClass(l),
					t(o).one(r.TRANSITION_END, function() {
						t(a).removeClass(l + " " + c).addClass(f.ACTIVE),
		...
		t(document).on(d.CLICK_DATA_API, p.DATA_SLIDE, g._dataApiClickHandler),
		  ...
		  , p = function() {
			...
			s.prototype.show = function() {
				...
				if (!t(this._element).hasClass(h.SHOW)) {
					var n = void 0
					  , i = void 0;
					if (this._parent && (n = t.makeArray(t(this._parent).find(f.ACTIVES)),
					n.length || (n = null)),
					!(n && (i = t(n).data(a)) && i._isTransitioning)) {
						...
						!o.isDefaultPrevented()) {
							...
							t(this._element).removeClass(h.COLLAPSE).addClass(h.COLLAPSING),
							this._element.style[l] = 0,
							this._element.setAttribute("aria-expanded", !0),
							this._triggerArray.length && t(this._triggerArray).removeClass(h.COLLAPSED).attr("aria-expanded", !0),
							this.setTransitioning(!0);
							var c = function() {
								t(e._element).removeClass(h.COLLAPSING).addClass(h.COLLAPSE).addClass(h.SHOW),
								e._element.style[l] = "",
				...
				if (t(this._element).hasClass(h.SHOW)) {
					...
					!n.isDefaultPrevented()) {
						var i = this._getDimension()
						  , o = i === d.WIDTH ? "offsetWidth" : "offsetHeight";
						this._element.style[i] = this._element[o] + "px",
						r.reflow(this._element),
						t(this._element).addClass(h.COLLAPSING).removeClass(h.COLLAPSE).removeClass(h.SHOW),
						this._element.setAttribute("aria-expanded", !1),
						this._triggerArray.length && t(this._triggerArray).addClass(h.COLLAPSED).attr("aria-expanded", !1),
						this.setTransitioning(!0);
						var a = function() {
							e.setTransitioning(!1),
							t(e._element).removeClass(h.COLLAPSING).addClass(h.COLLAPSE).trigger(u.HIDDEN)
						};
				...
				if (!n || 3 !== n.which) {
					...
					for (var o = t.makeArray(t(c.DATA_TOGGLE)), r = 0; r < o.length; r++) {
						...
						if (t(a).hasClass(l.SHOW) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "focusin" === n.type) && t.contains(a, n.target))) {
							...
							t(a).trigger(h),
							h.isDefaultPrevented() || (o[r].setAttribute("aria-expanded", "false"),
							t(a).removeClass(l.SHOW).trigger(t.Event(s.HIDDEN, u)))
						}
					}
				}
			}
		...
		var e = "modal"
		  ...
		  , f = function() {
			...
			s.prototype.show = function(e) {
				...
				this._setScrollbar(),
				t(document.body).addClass(h.OPEN),
				this._setEscapeEvent(),
				this._setResizeEvent(),
				t(this._element).on(u.CLICK_DISMISS, d.DATA_DISMISS, function(t) {
					return n.hide(t)
				}),
			...
			s.prototype.hide = function(e) {
				...
				t(this._element).removeClass(h.SHOW),
			...
			s.prototype._showElement = function(e) {
				...
				t(this._element).addClass(h.SHOW),
			...
			s.prototype._hideModal = function() {
				...
				this._isTransitioning = !1,
				this._showBackdrop(function() {
					t(document.body).removeClass(h.OPEN),
					e._resetAdjustments(),
					e._resetScrollbar(),
			...
			s.prototype._showBackdrop = function(e) {
				...
				if (this._isShown && this._config.backdrop) {
					...
					t(this._backdrop).addClass(h.SHOW),
					!e)
						return;
					if (!o)
						return void e();
		  ...
		  , f = function() {
			...
			return a.prototype.refresh = function() {
				...
				t.makeArray(t(this._selector)).map(function(e) {
					...
					return a && (n = t(a)[0]),
					n && (n.offsetWidth || n.offsetHeight) ? [t(n)[i]().top + o, a] : null
				}).filter(function(t) {
					return t
				}).sort(function(t, e) {
					return t[0] - e[0]
			...
			a.prototype._activate = function(e) {
				...
				var i = t(n.join(","));
				i.hasClass(u.DROPDOWN_ITEM) ? (i.closest(h.DROPDOWN).find(h.DROPDOWN_TOGGLE).addClass(u.ACTIVE),
				i.addClass(u.ACTIVE)) : i.parents(h.LI).find("> " + h.NAV_LINKS).addClass(u.ACTIVE),
		  ...
		  , l = function() {
			...
			return e.prototype.show = function() {
				...
				if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(a.ACTIVE) || t(this._element).hasClass(a.DISABLED))) {
					...
					l && (o = t.makeArray(t(l).find(s.ACTIVE)),
					o = o[o.length - 1]);
			...
			e.prototype._transitionComplete = function(e, n, i, o) {
				if (n) {
					...
					l && t(l).removeClass(a.ACTIVE),
					n.setAttribute("aria-expanded", !1)
				}
				if (t(e).addClass(a.ACTIVE),
				e.setAttribute("aria-expanded", !0),
				i ? (r.reflow(e),
				t(e).addClass(a.SHOW)) : t(e).removeClass(a.FADE),
				e.parentNode && t(e.parentNode).hasClass(a.DROPDOWN_MENU)) {
					var c = t(e).closest(s.DROPDOWN)[0];
					c && t(c).find(s.DROPDOWN_TOGGLE).addClass(a.ACTIVE),
					e.setAttribute("aria-expanded", !0)
				}
				o && o()
			}
		...
		var e = "tooltip"
		  ...
		  , v = function() {
			...
			s.prototype.show = function() {
				...
				if (this.isWithContent() && this._isEnabled) {
					...
					var d = function() {
						...
						n === h.OUT && e._leave(null, e)
					};
					if (r.supportsTransitionEnd() && t(this.tip).hasClass(f.FADE))
						return this._isTransitioning = !0,
						void t(this.tip).one(r.TRANSITION_END, d).emulateTransitionEnd(s._TRANSITION_DURATION);
					d()
				}
			}
			,
			s.prototype.hide = function(e) {
				...
				o.isDefaultPrevented() || (t(i).removeClass(f.SHOW),
				this._activeTrigger[m.CLICK] = !1,
				this._activeTrigger[m.FOCUS] = !1,
				this._activeTrigger[m.HOVER] = !1,
				r.supportsTransitionEnd() && t(this.tip).hasClass(f.FADE) ? (this._isTransitioning = !0,
				t(i).one(r.TRANSITION_END, a).emulateTransitionEnd(150)) : a(),
				this._hoverState = "")
			}
			,
			...
			s.prototype._enter = function(e, n) {
				...
				t(n.getTipElement()).hasClass(f.SHOW) || n._hoverState === h.SHOW ? void (n._hoverState = h.SHOW) : (clearTimeout(n._timeout),
			...
			s._jQueryInterface = function(e) {
				return this.each(function() {
					var n = t(this).data("bs.tooltip")
					  , o = "object" === (void 0 === e ? "undefined" : i(e)) && e;
					if ((n || !/dispose|hide/.test(e)) && (n || (n = new s(this,o),
			...
			l--); c > l; l++)
				if (null != (r = arguments[l]))
					for (o in r)
						t = s[o],
						i = r[o],
						s !== i && (u && i && (n.isPlainObject(i) || (e = n.isArray(i))) ? (e ? (e = !1,
...
function(t) {
	...
	return function(t, e, n, i) {
		...
		function l(t, n, i, o) {
			...
			function f(e) {
				for (var n = 0, o = 1, r = b - 1; o != r && T[o] <= e; ++o)
					n += w;
				--o;
		...
		function c(t, e) {
			var n = t;
			return g.isString(t) ? b.Easings[t] || (n = !1) : n = g.isArray(t) && 1 === t.length ? s.apply(null, t) : g.isArray(t) && 2 === t.length ? w.apply(null, t.concat([e])) : !(!g.isArray(t) || 4 !== t.length) && l.apply(null, t),
								...
								for (var A in C)
									if ("element" !== A) {
										...
										"tween" === A)
											...
											x.Hooks.registered[A] && (a(S).rootPropertyValueCache[O] = x.Normalizations.registered[O] ? x.Normalizations.registered[O]("extract", null, F[1]) : F[1]),
											"transform" === F[0] && (E = !0)
										}
									}
								c.mobileHA && a(S).transformCache.translate3d === i && (a(S).transformCache.translate3d = "(0px, 0px, 0px)",
								E = !0),
								E && x.flushTransformCache(S)
							}
						}
						c.display !== i && "none" !== c.display && (b.State.calls[r][2].display = !1),
						c.visibility !== i && "hidden" !== c.visibility && (b.State.calls[r][2].visibility = !1),
						c.progress && c.progress.call(s[1], s[1], v, Math.max(0, f + c.duration - e), f, m),
						1 === v && h(r)
					}
			}
		...
		function h(t, e) {
			...
			for (var n = b.State.calls[t][0], o = b.State.calls[t][1], r = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, c = 0, u = n.length; u > c; c++) {
				var h = n[c].element;
				if (e || r.loop || ("none" === r.display && x.setPropertyValue(h, "display", r.display),
				"hidden" === r.visibility && x.setPropertyValue(h, "visibility", r.visibility)),
				r.loop !== !0 && (d.queue(h)[1] === i || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && a(h)) {
					a(h).isAnimating = !1,
					...
					d.each(x.Lists.transforms3D, function(t, e) {
						...
						a(h).transformCache[e] !== i && new RegExp("^\\(" + n + "[^.]").test(o) && (f = !0,
				...
				s && r.loop !== !0 && s(o),
				a(h) && r.loop === !0 && !e && (d.each(a(h).tweensContainer, function(t, e) {
						...
						!function() {
							...
							x.Normalizations.registered[e] = function(t, n, o) {
								...
								case "inject":
									...
									case "scal":
									case "scale":
										b.State.isAndroid && a(n).transformCache[e] === i && 1 > o && (o = 1),
										r = !/(\d)$/i.test(o);
										break;
									case "skew":
										r = !/(deg|\d)$/i.test(o);
									...
									return r || (a(n).transformCache[e] = "(" + o + ")"),
							...
							x.Normalizations.registered[e] = function(t, n, o) {
								...
								case "extract":
									...
									if (x.RegEx.wrappedValueAlreadyExtracted.test(o))
										...
										/^[A-z]+$/i.test(o) ? a = s[o] !== i ? s[o] : s.black : x.RegEx.isHex.test(o) ? a = "rgb(" + x.Values.hexToRgb(o).join(" ") + ")" : /^rgba?\(/i.test(o) || (a = s.black),
										r = (a || o).toString().match(x.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
									}
			...
			getPropertyValue: function(t, n, o, r) {
				function s(t, n) {
					...
					if (8 >= f)
						...
						var p;
						p = a(t) === i ? e.getComputedStyle(t, null) : a(t).computedStyle ? a(t).computedStyle : a(t).computedStyle = e.getComputedStyle(t, null),
						"borderColor" === n && (n = "borderTopColor"),
						l = 9 === f && "filter" === n ? p.getPropertyValue(n) : p[n],
				...
				if (x.Hooks.registered[n]) {
					var c = n
					  , u = x.Hooks.getRoot(c);
					o === i && (o = x.getPropertyValue(t, x.Names.prefixCheck(u)[0])),
					...
					var h, p;
					h = x.Normalizations.registered[n]("name", t),
					"transform" !== h && (p = s(t, x.Names.prefixCheck(h)[0]),
					x.Values.isCSSNullValue(p) && x.Hooks.templates[n] && (p = x.Hooks.templates[n][1])),
					l = x.Normalizations.registered[n]("extract", t, p)
				}
				if (!/^[\d-]/.test(l))
			...
			setPropertyValue: function(t, n, i, o, r) {
				...
				if ("scroll" === n)
					...
					8 >= f)
						...
						a(t) && a(t).isSVG && x.Names.SVGAttribute(n) ? t.setAttribute(n, i) : t.style[s] = i;
		...
		var C = function() {
			...
			function o() {
				function t(t) {
					function h(t, e) {
						var n = i
						  , o = i
						  , a = i;
						return g.isArray(t) ? (n = t[0],
						!g.isArray(t[1]) && /^[\d-]/.test(t[1]) || g.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? a = t[1] : (g.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || g.isArray(t[1])) && (o = e ? t[1] : c(t[1], s.duration),
						t[2] !== i && (a = t[2]))) : n = t,
						e || (o = o || s.easing),
						g.isFunction(n) && (n = n.call(r, S, T)),
						g.isFunction(a) && (a = a.call(r, S, T)),
						[n || 0, o, a]
					}
					function f(t, e) {
						var n, i;
					...
					if ("scroll" === _) {
						...
						v = s.container["scroll" + E],
						C = v + d(r).position()[E.toLowerCase()] + k) : s.container = null : (v = b.State.scrollAnchor[b.State["scrollProperty" + E]],
						w = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === E ? "Top" : "Left")]],
						C = d(r).offset()[E.toLowerCase()] + k),
						l = {
							scroll: {
								rootPropertyValue: !1,
								startValue: v,
						...
						if (!a(r).tweensContainer)
							return void d.dequeue(r, s.queue);
						...
						for (var I in P)
							if ("element" !== I) {
								...
								P[I].endValue = D,
								g.isEmptyObject(y) || (P[I].easing = s.easing),
								b.debug && console.log("reverse tweensContainer (" + I + "): " + JSON.stringify(P[I]), r)
							}
						l = P
					} else if ("start" === _) {
						var P;
						a(r).tweensContainer && a(r).isAnimating === !0 && (P = a(r).tweensContainer),
						...
						for (var O in m) {
							...
							if (a(r).isSVG || "tween" === H || x.Names.prefixCheck(H)[1] !== !1 || x.Normalizations.registered[H] !== i) {
								(s.display !== i && null !== s.display && "none" !== s.display || s.visibility !== i && "hidden" !== s.visibility) && /opacity|filter/.test(O) && !W && 0 !== M && (W = 0),
								s._cacheValues && P && P[O] ? (W === i && (W = P[O].endValue + P[O].unitType),
								j = a(r).rootPropertyValueCache[H]) : x.Hooks.registered[O] ? W === i ? (j = x.getPropertyValue(r, H),
								W = x.getPropertyValue(r, O, j)) : j = x.Hooks.templates[H][1] : W === i && (W = x.getPropertyValue(r, O));
								var z, V, B, q = !1;
								if (z = f(O, W),
								W = z[0],
								B = z[1],
								z = f(O, M),
								M = z[0].replace(/^([+-\/*])=/, function(t, e) {
									return q = e,
									""
								}),
								V = z[1],
								W = parseFloat(W) || 0,
								M = parseFloat(M) || 0,
								"%" === V && (/^(fontSize|lineHeight)$/.test(O) ? (M /= 100,
								V = "em") : /^scale/.test(O) ? (M /= 100,
								V = "") : /(Red|Green|Blue)$/i.test(O) && (M = M / 100 * 255,
								V = "")),
								/[\/*]/.test(q))
									V = B;
								else if (B !== V && 0 !== W)
									if (0 === M)
										...
										o = o || function() {
											...
											F.lastParent = t.myParent,
											F.lastPosition = t.position,
											F.lastFontSize = t.fontSize;
											var s = 100
											  , l = {};
											if (o && i)
												...
												l.percentToPxWidth = F.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(c, "width", null, !0)) || 1) / s,
												l.percentToPxHeight = F.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(c, "height", null, !0)) || 1) / s,
												l.emToPx = F.lastEmToPx = (parseFloat(x.getPropertyValue(c, "paddingLeft")) || 1) / s,
												t.myParent.removeChild(c)
											}
											return null === F.remToPx && (F.remToPx = parseFloat(x.getPropertyValue(n.body, "fontSize")) || 16),
					...
					N.push(l),
					"" === s.queue && (a(r).tweensContainer = l,
					a(r).opts = s),
					a(r).isAnimating = !0,
					S === T - 1 ? (b.State.calls.push([N, p, s, null, A.resolver]),
					b.State.isTicking === !1 && (b.State.isTicking = !0,
					u())) : S++)
				}
				var o, r = this, s = d.extend({}, b.defaults, y), l = {};
				switch (a(r) === i && b.init(r),
				parseFloat(s.delay) && s.queue !== !1 && d.queue(r, s.queue, function(t) {
				...
				s.queue === !1 ? s.delay ? setTimeout(t, s.delay) : t() : d.queue(r, s.queue, function(e, n) {
					return n === !0 ? (A.promise && A.resolver(p),
			...
			p = r(p)) {
				...
				y = arguments[0].options || arguments[0].o) : (m = arguments[f],
				y = arguments[f + 1]);
				var T = p.length
				  , S = 0;
				if (!/^(stop|finish)$/i.test(m) && !d.isPlainObject(y)) {
					var E = f + 1;
					y = {};
					for (var k = E; k < arguments.length; k++)
						g.isArray(arguments[k]) || !/^(fast|normal|slow)$/i.test(arguments[k]) && !/^\d/.test(arguments[k]) ? g.isString(arguments[k]) || g.isArray(arguments[k]) ? y.easing = arguments[k] : g.isFunction(arguments[k]) && (y.complete = arguments[k]) : y.duration = arguments[k]
				}
				var A = {
					promise: null,
					resolver: null,
					...
					return d.each(b.State.calls, function(t, e) {
						e && d.each(e[1], function(n, o) {
							...
							return r !== !0 && e[2].queue !== r && (y !== i || e[2].queue !== !1) || void d.each(p, function(n, i) {
								...
								d.queue(i, g.isString(y) ? y : "", [])),
								"stop" === m ? (a(i) && a(i).tweensContainer && r !== !1 && d.each(a(i).tweensContainer, function(t, e) {
				...
				default:
					if (!d.isPlainObject(m) || g.isEmptyObject(m)) {
						if (g.isString(m) && b.Redirects[m]) {
							...
							d.each(p, function(t, e) {
								parseFloat(I.stagger) ? I.delay = O + parseFloat(I.stagger) * t : g.isFunction(I.stagger) && (I.delay = O + I.stagger.call(e, t, T)),
								I.drag && (I.duration = parseFloat(D) || (/^(callout|transition)/.test(m) ? 1e3 : v),
								I.duration = Math.max(I.duration * (I.backwards ? 1 - t / T : (t + 1) / T), .75 * I.duration, 200)),
								b.Redirects[m].call(e, e, I || {}, t, T, p, A.promise ? A : i)
							}),
							t()
						}
				...
				I.loop)
					for (var R = 0; M > R; R++) {
						...
						R === M - 1 && (W.display = I.display,
						W.visibility = I.visibility,
						W.complete = I.complete),
						C(p, "reverse", W)
					}
				return t()
			}
		...
		d.each(["Down", "Up"], function(t, e) {
			b.Redirects["slide" + e] = function(t, n, o, r, a, s) {
				var l = d.extend({}, n)
				  ...
				  , f = {};
				l.display === i && (l.display = "Down" === e ? "inline" === b.CSS.Values.getDisplayType(t) ? "inline-block" : "block" : "none"),
				l.begin = function() {
					c && c.call(a, a);
					for (var n in h) {
						f[n] = t.style[n];
...
function() {
	...
	var t = this
	  ...
	  , n = function(t) {
		...
		this.width = e(t.canvas, "Width") || t.canvas.width,
		this.height = e(t.canvas, "Height") || t.canvas.height;
		return this.width = t.canvas.width,
	...
	i.calculateOrderOfMagnitude = function(t) {
	  ...
	  , x = (i.calculateScaleRange = function(t, e, n, i, r) {
		...
		u === c && (u += .5,
		c >= .5 && !i ? c -= .5 : u += .5);
		for (var h = Math.abs(u - c), d = w(h), f = Math.ceil(u / (1 * Math.pow(10, d))) * Math.pow(10, d), p = i ? 0 : Math.floor(c / (1 * Math.pow(10, d))) * Math.pow(10, d), v = f - p, y = Math.pow(10, d), b = Math.round(v / y); (b > a || 2 * b < a) && !s; )
			if (b > a)
				y *= 2,
				(b = Math.round(v / y)) % 1 != 0 && (s = !0);
			else if (r && d >= 0) {
				if (y / 2 % 1 != 0)
					break;
				y /= 2,
	...
	i.easingEffects = {
		...
		easeInOutElastic: function(t) {
			var e = 1.70158
			  , n = 0
			  , i = 1;
			return 0 === t ? 0 : 2 == (t /= .5) ? 1 : (n || (n = .3 * 1.5 * 1),
			i < Math.abs(1) ? (i = 1,
			e = n / 4) : e = n / (2 * Math.PI) * Math.asin(1 / i),
	...
	i.animationLoop = function(t, e, n, i, o, r) {
		var a = 0
		  ...
		  , l = function() {
			...
			t.call(r, c, n, a),
			i.call(r, c, n),
			a < e ? r.animationFrame = T(l) : o.apply(r)
		};
		T(l)
	}
	,
	...
	i.unbindEvents = function(t, e) {
	  ...
	  , I = (i.getMaximumSize = i.getMaximumWidth,
	...
	a(n.Type.prototype, {
		...
		stop: function() {
			return n.animationService.cancelAnimation(this),
			this
		},
		resize: function(t) {
			this.stop();
		...
		render: function(t) {
			...
			this.options.animation && !t) {
				...
				n.animationService.addAnimation(this, e)
			} else
				this.draw(),
		...
		showTooltip: function(t, e) {
			if (void 0 === this.activeElements && (this.activeElements = []),
			function(t) {
				var e = !1;
			...
			.call(this, t) || e) {
				...
				t.length > 0)
					if (this.datasets && this.datasets.length > 1) {
						for (var r, a, s = this.datasets.length - 1; s >= 0 && (r = this.datasets[s].points || this.datasets[s].bars || this.datasets[s].segments,
						(a = l(r, t[0])) === -1); s--)
							;
						var c = []
						  , u = []
						  , h = function(t) {
							...
							return i.each(this.datasets, function(t) {
								...
								e[a] && e[a].hasValue() && l.push(e[a])
							}),
							i.each(l, function(t) {
								h.push(t.x),
								d.push(t.y),
								c.push(i.template(this.options.multiTooltipTemplate, t)),
								u.push({
	...
	n.Arc = n.Element.extend({
		...
		draw: function(t) {
			var e = this.ctx;
			e.beginPath(),
			e.arc(this.x, this.y, this.outerRadius < 0 ? 0 : this.outerRadius, this.startAngle, this.endAngle),
			e.arc(this.x, this.y, this.innerRadius < 0 ? 0 : this.innerRadius, this.endAngle, this.startAngle, !0),
			e.closePath(),
	...
	n.Scale = n.Element.extend({
		...
		fit: function() {
			...
			for (this.calculateYRange(n),
			this.buildYLabels(),
			this.calculateXLabelRotation(); n > this.endPoint - this.startPoint; )
				n = this.endPoint - this.startPoint,
				t = this.yLabelWidth,
				this.calculateYRange(n),
				this.buildYLabels(),
				t < this.yLabelWidth && (this.endPoint = e,
		...
		calculateXLabelRotation: function() {
			...
			if (this.xScalePaddingRight = n / 2 + 3,
		...
		draw: function() {
			...
			o(this.xLabels, function(e, n) {
				...
				t.rotate(y(this.xLabelRotation) * -1),
				t.font = this.font,
	...
	n.RadialScale = n.Element.extend({
		...
		setScaleSize: function() {
			...
			e = 0; e < this.valuesCount; e++)
				...
				o = e),
				t.x - i < g && (g = t.x - i,
				a = e)) : e < this.valuesCount / 2 ? t.x + n > f && (f = t.x + n,
				o = e) : e > this.valuesCount / 2 && t.x - n < g && (g = t.x - n,
				a = e);
			l = g,
			c = Math.ceil(f - this.width),
			...
			if (this.display) {
				...
				!this.lineArc) {
					...
					for (var e = this.valuesCount - 1; e >= 0; e--) {
						var n = null
						  , i = null;
						if (this.angleLineWidth > 0 && (n = this.calculateCenterOffset(this.max),
						i = this.getPointPosition(e, n),
						t.beginPath(),
						...
						this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
							...
							null == i && (i = this.getPointPosition(e, n));
						...
						var u = this.labels.length
						  ...
						  , f = e < d || e > u - d
						  , p = e === d || e === u - d;
						t.textAlign = 0 === e ? "center" : e === h ? "center" : e < h ? "left" : "right",
						t.textBaseline = p ? "middle" : f ? "bottom" : "top",
	...
	n.animationService = {
		...
		addAnimation: function(t, e) {
			for (var n = 0; n < this.animations.length; ++n)
				if (this.animations[n].chartInstance === t)
					return void (this.animations[n].animationObject = e);
		...
		startDigest: function() {
			...
			this.dropFrames -= e);
			for (var n = 0; n < this.animations.length; n++)
				null === this.animations[n].animationObject.currentStep && (this.animations[n].animationObject.currentStep = 0),
				this.animations[n].animationObject.currentStep += 1 + e,
				this.animations[n].animationObject.currentStep > this.animations[n].animationObject.numSteps && (this.animations[n].animationObject.currentStep = this.animations[n].animationObject.numSteps),
				this.animations[n].animationObject.render(this.animations[n].chartInstance, this.animations[n].animationObject),
				this.animations[n].animationObject.currentStep == this.animations[n].animationObject.numSteps && (this.animations[n].animationObject.onAnimationComplete.call(this.animations[n].chartInstance),
			...
			this.animations.length > 0 && i.requestAnimFrame.call(window, this.digestWrapper)
		}
	},
		...
		getBarsAtEvent: function(t) {
			for (var e, i = [], o = n.getRelativePosition(t), r = function(t) {
				...
				for (e = 0; e < this.datasets[a].bars.length; e++)
					if (this.datasets[a].bars[e].inRange(o.x, o.y))
						return n.each(this.datasets, r),
						i;
			return i
		},
	...
	e.Type.extend({
		...
		initialize: function(t) {
			...
			n.each(t, function(e, n) {
				e.color || (e.color = "hsl(" + 360 * n / t.length + ", 100%, 50%)"),
				this.addData(e, n, !0)
			}, this),
			this.render()
		},
		...
		addData: function(t, n, i) {
			...
			void 0 === t.color && (t.color = e.defaults.global.segmentColorDefault[o % e.defaults.global.segmentColorDefault.length],
		...
		draw: function(t) {
			var e = t ? t : 1;
			this.clear(),
			n.each(this.segments, function(t, n) {
				t.transition({
				...
				n < this.segments.length - 1 && (this.segments[n + 1].startAngle = t.endAngle)
			}, this)
		}
	}),
	...
	e.Type.extend({
		...
		draw: function(t) {
			...
			n.each(this.datasets, function(t) {
				...
				this.options.datasetStroke && i.stroke(),
	...
	e.Type.extend({
		...
		initialize: function(t) {
			...
			n.each(t.datasets, function(e) {
				...
				n.each(e.data, function(n, o) {
					var r;
					this.scale.animation || (r = this.scale.getPointPosition(o, this.scale.calculateCenterOffset(n))),
					i.points.push(new this.PointClass({
						value: n,
						label: t.labels[o],
						datasetLabel: e.label,
		...
		getPointsAtEvent: function(t) {
			var e = n.getRelativePosition(t)
			  ...
			  , a = [];
			return (r >= this.scale.valuesCount || r < 0) && (r = 0),
			i.distance <= this.scale.drawingArea && n.each(this.datasets, function(t) {
				a.push(t.points[r])
			}),
			a
		},
		...
		draw: function(t) {
			...
			n.each(this.datasets, function(t) {
				...
				i.strokeStyle = t.strokeColor,
				i.beginPath(),
				n.each(t.points, function(t, e) {
					0 === e ? i.moveTo(t.x, t.y) : i.lineTo(t.x, t.y)
				}, this),
				i.closePath(),
				i.stroke(),
				i.fillStyle = t.fillColor,
				this.options.datasetFill && i.fill(),
				n.each(t.points, function(t) {
					t.hasValue() && t.draw()
				})
			}, this)
			...
			init: function() {
				...
				function n() {
					...
					t(".wow.animated").each(function() {
						if (n + o - 100 > i(this) && o > i(this) + 100 || n + o - 100 < i(this) && o < i(this) + 100 || i(this) + t(this).height > t(document).height() - 100)
				...
				t(".wow").each(function() {
					...
					o[t(this).index(".wow")] = t(this).css("animation-name"),
					t(this).css({
						"animation-name": "none"
					})
				}),
...
function(t, e) {
	...
	function c(t) {
		...
		if (null !== e) {
			...
			"touchstart" === t.type && p.delay) {
				...
				p.show(t, e),
				f && (e.addEventListener("touchend", p.hide, !1),
				e.addEventListener("touchcancel", p.hide, !1)),
				e.addEventListener("mouseup", p.hide, !1),
				e.addEventListener("mouseleave", p.hide, !1)
		}
	}
	var u = u || {}
	  ...
	  , p = {
		...
		show: function(t, e, n) {
			...
			var o = r(e)
			  , s = 0
			  , l = 0;
			"touches"in t && t.touches.length ? (s = t.touches[0].pageY - o.top,
			l = t.touches[0].pageX - o.left) : (s = t.pageY - o.top,
			l = t.pageX - o.left),
			l = l >= 0 ? l : 0,
			s = s >= 0 ? s : 0;
		...
		hide: function(t, e) {
			e = e || this;
			for (var n = e.getElementsByClassName("waves-rippling"), i = 0, o = n.length; i < o; i++)
				s(t, e, n[i])
		}
	}
	  , g = {
	...
	return u.init = function(t) {
		var e = document.body;
		t = t || {},
		"duration"in t && (p.duration = t.duration),
		"delay"in t && (p.delay = t.delay),
		f && (e.addEventListener("touchstart", c, !1),
	...
	u.attach = function(t, e) {
		t = o(t),
		"[object Array]" === d.call(e) && (e = e.join(" ")),
		e = e ? " " + e : "";
		for (var n, i, r = 0, a = t.length; r < a; r++)
			n = t[r],
			i = n.tagName.toLowerCase(),
			["input", "img"].indexOf(i) !== -1 && (g[i](n),
			n = n.parentElement),
			n.className.indexOf("waves-effect") === -1 && (n.className += " waves-effect" + e)
	}
	,
...
function(t) {
	t(["jquery"], function(t) {
		return function() {
			...
			function h(e) {
				return v = t("<div/>").attr("id", e.containerId).addClass(e.positionClass).attr("aria-live", "polite").attr("role", "alert"),
			...
			function p(e) {
				...
				function a() {
					e.title && (S.append(y.escapeHtml ? i(e.title) : e.title).addClass(y.titleClass),
					T.append(S))
				}
				function s() {
					e.message && (E.append(y.escapeHtml ? i(e.message) : e.message).addClass(y.messageClass),
					T.append(E))
				}
				function l() {
					y.closeButton && (A.addClass("toast-close-button").attr("role", "button"),
					T.prepend(A))
				}
				function c() {
					y.progressBar && (k.addClass("toast-progress"),
					T.prepend(k))
				}
				function u(e) {
					...
					if (!t(":focus", T).length || e)
						return clearTimeout(_.intervalId),
						T[n]({
							duration: i,
							easing: o,
							complete: function() {
								m(T),
								y.onHidden && "hidden" !== P.state && y.onHidden(),
								P.state = "hidden",
								P.endTime = new Date,
								f(P)
							}
				...
				function h() {
					(y.timeOut > 0 || y.extendedTimeOut > 0) && (C = setTimeout(u, y.extendedTimeOut),
					_.maxHideTime = parseFloat(y.extendedTimeOut),
					_.hideEta = (new Date).getTime() + _.maxHideTime)
				}
				function d() {
					clearTimeout(C),
					_.hideEta = 0,
					T.stop(!0, !0)[y.showMethod]({
				...
				if (void 0 !== e.optionsOverride && (y = t.extend(y, e.optionsOverride),
				x = e.optionsOverride.iconClass || x),
				!function(t, e) {
					...
					function() {
						...
						y.timeOut > 0 && (C = setTimeout(u, y.timeOut),
						_.maxHideTime = parseFloat(y.timeOut),
						_.hideEta = (new Date).getTime() + _.maxHideTime,
						y.progressBar && (_.intervalId = setInterval(p, 10)))
					}(),
					function() {
						T.hover(d, h),
						!y.onclick && y.tapToDismiss && T.click(u),
						y.closeButton && A && A.click(function(t) {
	...
	t.fn.dropdown = function(e) {
		...
		this.each(function() {
			...
			function o(e) {
				...
				r + c.innerWidth() > t(window).width() ? h = "right" : r - c.innerWidth() + a.innerWidth() < 0 && (h = "left"),
				u + c.innerHeight() > n)
			...
			s.hover) {
				...
				a.on("mouseleave", function(e) {
					t(e.toElement || e.relatedTarget).closest(".dropdown-content").is(c) || (c.stop(!0, !0),
					r(),
					u = !1)
				}),
				c.on("mouseleave", function(e) {
					t(e.toElement || e.relatedTarget).closest(".dropdown-button").is(a) || (c.stop(!0, !0),
					r(),
					u = !1)
				})
			} else
				...
				a.bind("click." + a.attr("id"), function(e) {
					l || (a[0] != e.currentTarget || a.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? a.hasClass("active") && (r(),
					t(document).unbind("click." + c.attr("id") + " touchstart." + c.attr("id"))) : (e.preventDefault(),
					o("click")),
					c.hasClass("active") && t(document).bind("click." + c.attr("id") + " touchstart." + c.attr("id"), function(e) {
						c.is(e.target) || a.is(e.target) || a.find(e.target).length || (r(),
						t(document).unbind("click." + c.attr("id") + " touchstart." + c.attr("id")))
					}))
				});
...
function(t) {
	...
	t(document).ready(function() {
		...
		t(document).on("mouseenter.fixedActionBtn", ".fixed-action-btn:not(.click-to-toggle)", function(e) {
			n(t(this))
		}),
...
function(t, e, n, i) {
	...
	function k(t, e) {
		...
		o > 1 && !n.firstMultiple ? n.firstMultiple = P(e) : 1 === o && (n.firstMultiple = !1);
		var r = n.firstInput
		  , a = n.firstMultiple
		...
		e.scale = a ? M(a.pointers, i) : 1,
		e.rotation = a ? N(a.pointers, i) : 0,
	...
	function j(t, e) {
		...
		return e & (At | _t) && (n = b(n.concat(i), "identifier", !0)),
		[n, i]
	}
	function z() {
		this.evTarget = Gt,
	...
	function V(t, e) {
		...
		for (o = 0; o < a.length; )
			...
			e & (At | _t) && delete i[a[o].identifier],
			o++;
	...
	function q(t, e) {
		t & Et ? (this.primaryTouch = e.changedPointers[0].identifier,
		Y.call(this, e)) : t & (At | _t) && Y.call(this, e)
	}
	function Y(t) {
	...
	l(W, T, {
		handler: function(t) {
			...
			o & Et && (0 === t.button || a) ? s < 0 && (e.push(t),
			s = e.length - 1) : o & (At | _t) && (n = !0),
			s < 0 || (e[s] = t,
	...
	l(H, T, {
		handler: function(t) {
			...
			this.started) {
				...
				e & (At | _t) && n[0].length - n[1].length == 0 && (this.started = !1),
				this.callback(this.manager, e, {
					pointers: n[0],
					changedPointers: n[1],
					pointerType: "touch",
	...
	$.prototype = {
		set: function(t) {
			...
			te && this.manager.element.style && ae[t] && (this.manager.element.style[Jt] = t),
	...
	Q.prototype = {
		...
		dropRecognizeWith: function(t) {
			return r(t, "dropRecognizeWith", this) ? this : (t = K(t, this),
		...
		recognize: function(t) {
			...
			if (!u(this.options.enable, [this, e]))
				return this.reset(),
				void (this.state = 32);
			this.state & (he | de | 32) && (this.state = se),
			this.state = this.process(e),
			this.state & (le | ce | ue | de) && this.tryEmit(e)
		},
		process: function(t) {},
	...
	l(tt, J, {
		...
		directionTest: function(t) {
			var e = this.options
			  ...
			  , r = t.deltaX
			  , a = t.deltaY;
			return o & e.direction || (e.direction & Ft ? (o = 0 === r ? Pt : r < 0 ? It : Dt,
			n = r != this.pX,
			i = Math.abs(t.deltaX)) : (o = 0 === a ? Pt : a < 0 ? Ot : Lt,
			n = a != this.pY,
			i = Math.abs(t.deltaY))),
			t.direction = o,
	...
	l(nt, Q, {
		...
		emit: function(t) {
			this.state === he && (t && t.eventType & At ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = mt(),
	...
	l(ot, J, {
		...
		attrTest: function(t) {
			...
			return n & (Ft | Nt) ? e = t.overallVelocity : n & Ft ? e = t.overallVelocityX : n & Nt && (e = t.overallVelocityY),
			this._super.attrTest.call(this, t) && n & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && gt(e) > this.options.velocity && t.eventType & At
		},
		emit: function(t) {
	...
	var e = {
		init: function(e) {
			...
			t(this).each(function() {
				...
				o.hasClass("fixed") && window.innerWidth > 1440 && o.css("transform", "translateX(0)"),
				...
				r.hammer({
					...
					if ("touch" == i.gesture.pointerType) {
						...
						if ("left" === e.edge && (r > e.menuWidth ? r = e.menuWidth : r < 0 && (r = 0)),
						"left" === e.edge)
							r < e.menuWidth / 2 ? s = !1 : r >= e.menuWidth / 2 && (s = !0),
							o.css("transform", "translateX(" + (r - e.menuWidth) + "px)");
						else {
						...
						t("#sidenav-overlay").velocity({
							...
							queue: !1,
							easing: "easeOutQuad"
						})) : (h = Math.abs((r - window.innerWidth) / e.menuWidth),
						t("#sidenav-overlay").velocity({
							opacity: h
						}, {
							duration: 10,
					...
					if ("touch" == n.gesture.pointerType) {
						...
						u < 0 && (u = 0),
						a = !1,
						"left" === e.edge ? s && i <= .3 || i < -.5 ? (0 != c && o.velocity({
							translateX: [0, c]
						}, {
							duration: 300,
							queue: !1,
...
function(t) {
	t.fn.collapsible = function(e) {
		...
		this.each(function() {
			...
			e.accordion || "accordion" === l || void 0 === l ? (s = a.find("> li > .collapsible-header"),
...
function(t, e) {
	...
	var e = function(t, e) {
		...
		i.width = i.height = e.size * r,
		o.scale(r, r)),
		o.translate(e.size / 2, e.size / 2),
		o.rotate((-.5 + e.rotate / 180) * Math.PI);
		...
		this.draw = function(t) {
			...
			n = o.getImageData(0, 0, e.size * r, e.size * r)) : (this.clear(),
			u()) : this.clear(),
			o.lineCap = e.lineCap;
			var i;
		...
		this.animate = function(t, n) {
			...
			var o = function() {
				...
				this.draw(a),
				e.onStep(t, n, a),
				r >= e.animate.duration ? e.onStop(t, n) : c(o)
			}
			.bind(this);
			c(o)
		}
...
function(t) {
	t(document).ready(function() {
		...
		t(document).on("change", '.file-field input[type="file"]', function() {
			for (var e = t(this).closest(".file-field"), n = e.find("input.file-path"), i = t(this)[0].files, o = [], r = 0; r < i.length; r++)
				o.push(i[r].name);
			n.val(o.join(", ")),
			n.trigger("change")
		});
		...
		t(document).on("input mousedown touchstart", r, function(e) {
			var n = t(this).siblings(".thumb")
			  , i = t(this).outerWidth();
			n.length <= 0 && (n = t('<span class="thumb"><span class="value"></span></span>'),
			t(this).after(n)),
			...
			"input" !== e.type && (o = void 0 === e.pageX || null === e.pageX ? e.originalEvent.touches[0].pageX - t(this).offset().left : e.pageX - t(this).offset().left,
			o < 0 ? o = 0 : o > i && (o = i),
		...
		t(document).on("mousemove touchmove", ".range-field", function(e) {
			...
			if (a) {
				...
				i.find(".value").html(i.siblings(r).val())
			}
		}),
	...
	t.fn.material_select = function(e) {
		function n(t, e, n) {
			var o = t.indexOf(e)
			  , r = o === -1;
			return r ? t.push(e) : t.splice(o, 1),
			n.siblings("ul.dropdown-content").find("li").eq(e).toggleClass("active"),
		...
		t(this).each(function() {
			...
			if (!i.hasClass("browser-default")) {
				var o = !!i.attr("multiple")
				  , r = i.data("select-id");
				if (r && (i.parent().find("span.caret").remove(),
				...
				var l = t('<ul id="select-options-' + a + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>')
				  ...
				  , f = function() {
					...
					e.find("li").find("span.filtrable").each(function() {
						"string" == typeof this.outerText && (this.outerText.toLowerCase().indexOf(n.toLowerCase()) === -1 ? (t(this).hide(),
				...
				var g = function(e, n, i) {
					...
					if (a) {
						var c = "";
						return s && (c = ' class="' + s + '"'),
						"multiple" === i ? l.append(t('<li class="' + o + '"><img alt="" src="' + a + '"' + c + '><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + n.html() + "</span></li>")) : l.append(t('<li class="' + o + r + '"><img alt="" src="' + a + '"' + c + '><span class="filtrable">' + n.html() + "</span></li>")),
						!0
					}
				...
				c.length && c.each(function() {
					if (t(this).is("option"))
						o ? g(0, t(this), "multiple") : g(0, t(this));
				...
				l.find("li:not(.optgroup)").each(function(r) {
					t(this).click(function(a) {
						if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
							...
							s = n(u, t(this).index() - 1, i),
							y.trigger("focus")) : (l.find("li").removeClass("active"),
				...
				y.before(m),
				y.after(l),
				i.is(":disabled") || y.dropdown({
					hover: !1,
					closeOnClick: !1
				}),
				i.attr("tabindex") && t(y[0]).attr("tabindex", i.attr("tabindex")),
				...
				var b = function(e, n) {
				  ...
				  , x = function(e) {
					if (9 == e.which)
						return void y.trigger("close");
					if (40 == e.which && !l.is(":visible"))
						return void y.trigger("open");
					if (13 != e.which || l.is(":visible")) {
						...
						40 == e.which && (a = l.find("li.selected").length ? l.find("li.selected").next("li:not(.disabled)")[0] : l.find("li:not(.disabled)")[0],
						b(l, a)),
						27 == e.which && y.trigger("close"),
						38 == e.which && (a = l.find("li.selected").prev("li:not(.disabled)")[0]) && b(l, a),
						setTimeout(function() {
							w = []
						}, 1e3)
					}
...
function(t) {
	...
	function e(r, a, l, d) {
		...
		function p() {
			E.data(a, A).addClass(S.input).val(E.data("value") ? A.get("select", T.format) : r.value),
			T.editable || E.on("focus." + C.id + " click." + C.id, function(t) {
				t.preventDefault(),
				A.open()
			}).on("keydown." + C.id, w),
			o(r, {
		...
		function m() {
			A.$holder.on({
				...
				focusin: function(t) {
					A.$root.removeClass(S.focused),
					t.stopPropagation()
				},
				"mousedown click": function(e) {
					var n = e.target;
					n != A.$holder[0] && (e.stopPropagation(),
				...
				var e = t(this)
				  ...
				  , o = s();
				o = o && (o.type || o.href),
				(i || o && !t.contains(A.$root[0], o)) && A.$holder[0].focus(),
				!i && n.nav ? A.set("highlight", A.component.item.highlight, {
					nav: n.nav
				}) : !i && "pick"in n ? (A.set("select", n.pick),
				T.closeOnSelect && A.close(!0)) : n.clear ? (A.clear(),
				T.closeOnClear && A.close(!0)) : n.close && A.close(!0)
			})
		}
		function v() {
			var e;
			T.hiddenName === !0 ? (e = r.name,
			r.name = "") : (e = ["string" == typeof T.hiddenPrefix ? T.hiddenPrefix : "", "string" == typeof T.hiddenSuffix ? T.hiddenSuffix : "_submit"],
			e = e[0] + r.name + e[1]),
			A._hidden = t('<input type=hidden name="' + e + '"' + (E.data("value") || r.value ? ' value="' + A.get("select", T.formatSubmit) + '"' : "") + ">")[0],
			E.on("change." + C.id, function() {
		...
		function w(t) {
			...
			if (27 == e)
				return A.close(!0),
				!1;
			(32 == e || n || !C.open && A.component.key[e]) && (t.preventDefault(),
			t.stopPropagation(),
			n ? A.clear().close() : A.open())
		}
		if (!r)
			return e;
		var x = !1
		  ...
		  , A = k.prototype = {
			...
			start: function() {
				...
				C.type = r.type,
				r.autofocus = r == s(),
				r.readOnly = !T.editable,
				r.id = r.id || C.id,
				"text" != r.type && (r.type = "text"),
				A.component = new l(A,T),
				A.$root = t('<div class="' + S.picker + '" id="' + r.id + '_root" />'),
				g(),
				A.$holder = t(f()).appendTo(A.$root),
				m(),
				T.formatSubmit && v(),
				p(),
				T.containerHidden ? t(T.containerHidden).append(A._hidden) : E.after(A._hidden),
				T.container ? t(T.container).append(A.$root) : E.after(A.$root),
				A.on({
				...
				x = n(A.$holder[0]),
				r.autofocus && A.open(),
				A.trigger("start").trigger("render"))
			},
			render: function(e) {
				return e ? (A.$holder = t(f()),
				m(),
				A.$root.html(A.$holder)) : A.$root.find("." + S.box).html(A.component.nodes(C.open)),
				A.trigger("render")
			},
			stop: function() {
				return C.start ? (A.close(),
				A._hidden && A._hidden.parentNode.removeChild(A._hidden),
				A.$root.remove(),
				E.removeClass(S.input).removeData(a),
				setTimeout(function() {
					E.off("." + C.id)
				}, 0),
				r.type = C.type,
			...
			open: function(n) {
				return C.open ? A : (E.addClass(S.active),
				o(r, "expanded", !0),
				setTimeout(function() {
					A.$root.addClass(S.opened),
					o(A.$root[0], "hidden", !1)
				}, 0),
				n !== !1 && (C.open = !0,
				x && u.css("overflow", "hidden").css("padding-right", "+=" + i()),
				y(),
				c.on("click." + C.id + " focusin." + C.id, function(t) {
					var e = t.target;
					...
					var i = n.keyCode
					  , o = A.component.key[i]
					  , r = n.target;
					27 == i ? A.close(!0) : r != A.$holder[0] || !o && 13 != i ? t.contains(A.$root[0], r) && 13 == i && (n.preventDefault(),
					r.click()) : (n.preventDefault(),
					o ? e._.trigger(A.component.key.go, A, [e._.trigger(o)]) : A.$root.find("." + S.highlighted).hasClass(S.disabled) || (A.set("select", A.component.item.highlight),
					T.closeOnSelect && A.close(!0)))
				})),
				A.trigger("open"))
			},
			close: function(t) {
				return t && (T.editable ? r.focus() : (A.$holder.off("focus.toOpen").focus(),
				setTimeout(function() {
				...
				o(r, "expanded", !1),
				setTimeout(function() {
					A.$root.removeClass(S.opened + " " + S.focused),
					o(A.$root[0], "hidden", !0)
				}, 0),
				C.open ? (C.open = !1,
				x && u.css("overflow", "").css("padding-right", "-=" + i()),
				c.off("." + C.id),
				A.trigger("close")) : A
			},
			clear: function(t) {
			...
			set: function(e, n, i) {
				...
				e) {
					...
					for (o in s)
						r = s[o],
						o in A.component.item && (void 0 === r && (r = null),
						A.component.set(o, r, i)),
						"select" != o && "clear" != o || E.val("clear" == o ? "" : A.get(o, T.format)).trigger("change");
					A.render()
				}
			...
			off: function() {
				...
				namesCount = n.length; t < namesCount; t += 1)
					(e = n[t])in C.methods && delete C.methods[e];
				return A
			},
...
function(t) {
	...
	n.prototype.set = function(t, e, n) {
		...
		o[t] = e,
		i) : (o["enable" == t ? "disable" : "flip" == t ? "enable" : t] = i.queue[t].split(" ").map(function(o) {
			return e = i[o](t, e, n)
		}).pop(),
		"select" == t ? i.set("highlight", o.select, n) : "highlight" == t ? i.set("view", o.highlight, n) : t.match(/^(flip|min|max|disable|enable)$/) && (o.select && i.disabled(o.select) && i.set("select", o.select, n),
	...
	n.prototype.create = function(t, n, o) {
		...
		n == -(1 / 0) || n == 1 / 0 ? r = n : e.isPlainObject(n) && i.isInteger(n.pick) ? n = n.obj : e.isArray(n) ? (n = new Date(n[0],n[1],n[2]),
		n = i.isDate(n) ? n : a.create().obj) : n = i.isInteger(n) || i.isDate(n) ? a.normalize(new Date(n), o) : a.now(t, n, o),
		{
	...
	n.prototype.navigate = function(t, n, i) {
		...
		if (l || c) {
			...
			a = u.month),
			o = new Date(r,a + (i && i.nav ? i.nav : 0),1),
			r = o.getFullYear(),
	...
	n.prototype.validate = function(t, n, o) {
		...
		if ((!o || !o.nav && !o.defaultValue) && (!d && c.disabled(n) || d && c.disabled(n) && (g || r || a) || !d && (n.pick <= f.pick || n.pick >= p.pick)))
			for (d && !g && (!a && h > 0 || !r && h < 0) && (h *= -1); c.disabled(n) && (Math.abs(h) > 1 && (n.month < u.month || n.month > u.month) && (n = u,
			h = h > 0 ? 1 : -1),
			n.pick <= f.pick ? (s = !0,
			h = 1,
			...
			!s || !l); )
				n = c.create([n.year, n.month, n.date + h]);
		return n
	}
	,
	n.prototype.disabled = function(t) {
		...
		n.item.enable === -1 ? !o : o || t.pick < n.item.min.pick || t.pick > n.item.max.pick
	}
	,
	n.prototype.parse = function(t, e, n) {
		var o = this
		  , r = {};
		return e && "string" == typeof e ? (n && n.format || (n = n || {},
		n.format = o.settings.format),
	...
	n.prototype.deactivate = function(t, n) {
		...
		return "flip" == n ? o.flipEnable() : n === !1 ? (o.flipEnable(1),
		r = []) : n === !0 ? (o.flipEnable(-1),
		r = []) : n.map(function(t) {
	...
	n.prototype.activate = function(t, n) {
		var o = this
		  , r = o.item.disable
		  , a = r.length;
		return "flip" == n ? o.flipEnable() : n === !0 ? (o.flipEnable(1),
		r = []) : n === !1 ? (o.flipEnable(-1),
		r = []) : n.map(function(t) {
			var n, s, l, c;
			for (l = 0; l < a; l += 1) {
				if (s = r[l],
				...
				if (o.isDateOverlap(s, t)) {
					...
					n = t) : e.isArray(t) ? (n = t,
					n[3] || n.push("inverted")) : i.isDate(t) && (n = [t.getFullYear(), t.getMonth(), t.getDate(), "inverted"]);
					break
				}
			}
			if (n)
				...
				return [i.group({
					...
					item: function(t) {
						...
						return [i.node("div", t.date, function(e) {
							return e.push(l.month == t.month ? n.klass.infocus : n.klass.outfocus),
							r.pick == t.pick && e.push(n.klass.now),
							o && e.push(n.klass.selected),
							d && e.push(n.klass.highlighted),
							f && e.push(n.klass.disabled),
							e.join(" ")
...
function() {
	...
	function i(i, a) {
		function l(t, e) {
			...
			if (!e || !(d < y - w || d > y + w)) {
				...
				s.off(p).on(p, function(t) {
					...
					(e || g) && i === l && c === u && P.setHand(i, c),
					"hours" === P.currentView ? P.toggleView("minutes", C / 2) : a.autoclose && (P.minutesView.addClass("clockpicker-dial-out"),
					setTimeout(function() {
						P.done()
					}, C / 2)),
					h.prepend(R),
		...
		a.twelvehour) {
			...
			r(I);
			a.ampmclickable ? (this.spanAmPm.empty(),
			r('<div id="click-am">AM</div>').on("click", function() {
				P.spanAmPm.children("#click-am").addClass("text-primary"),
				P.spanAmPm.children("#click-pm").removeClass("text-primary"),
				P.amOrPm = "AM"
			}).appendTo(this.spanAmPm),
			r('<div id="click-pm">PM</div>').on("click", function() {
			...
			r('<button type="button" class="btn-floating btn-flat clockpicker-button pm-button" tabindex="2">PM</button>').on("click", function() {
				P.amOrPm = "PM",
		...
		r('<button type="button" class="btn-flat clockpicker-button" tabindex="' + (a.twelvehour ? "3" : "1") + '">' + a.donetext + "</button>").click(r.proxy(this.done, this)).appendTo(this.footer),
		this.spanHours.click(r.proxy(this.toggleView, this, "hours")),
		this.spanMinutes.click(r.proxy(this.toggleView, this, "minutes")),
		A.on("focus.clockpicker click.clockpicker", r.proxy(this.show, this));
		...
		c) {
			...
			W.setAttribute("width", x),
			W.setAttribute("height", x);
			var H = t("g");
			...
			V.setAttribute("r", w);
			var B = t("circle");
			B.setAttribute("class", "clockpicker-canvas-fg"),
			B.setAttribute("r", 5),
			H.appendChild(z),
			H.appendChild(V),
			H.appendChild(B),
	...
	i.prototype.show = function(t) {
		if (!this.isShown) {
			...
			if (this.options.twelvehour && void 0 !== i[1] && (i[1] = i[1].replace("AM", "").replace("PM", "")),
			"now" === i[0]) {
			...
			this.locate(),
			this.isShown = !0,
			s.on("click.clockpicker." + this.id + " focusin.clockpicker." + this.id, function(t) {
				var e = r(t.target);
	...
	i.prototype.toggleView = function(t, e) {
		var n = !1;
		"minutes" === t && "visible" === r(this.hoursView).css("visibility") && (o(this.options.beforeHourSelect),
		n = !0);
		var i = "hours" === t
	...
	i.prototype.setHand = function(t, n, i, o) {
		...
		a = Math.round(s / u),
		s = a * u,
		d.twelvehour ? l ? 0 === a && (a = 12) : (i && (a *= 5),
		60 === a && (a = 0)) : l ? (12 === a && (a = 0),
		a = f ? 0 === a ? 12 : a : 0 === a ? 0 : a + 12) : (i && (a *= 5),
		60 === a && (a = 0)),
		l ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : a % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"),
		this[this.currentView] !== a && g && this.options.vibrate && (this.vibrateTimer || (navigator[g](10),
		this.vibrateTimer = setTimeout(r.proxy(function() {
			this.vibrateTimer = null
		}, this), 100))),
		this[this.currentView] = a,
		this[l ? "spanHours" : "spanMinutes"].html(e(a)),
		!c)
			return void this[l ? "hoursView" : "minutesView"].find(".clockpicker-tick").each(function() {
				var t = r(this);
				t.toggleClass("active", a === +t.html())
			});
		o || !l && a % 5 ? (this.g.insertBefore(this.hand, this.bearing),
...
function(t, e) {
	...
	return function(t, e, n, i) {
		...
		var s, l, c, u, h, d, f, p, g, m, v, y, b, w, x, C, T, S, E, k, A, _, P, I, D, O, L, F, N, M, R, W, H, j, z, V, B, q, Y, X, $, U, Q, G, Z, K, J, tt, et, nt, it, ot, rt, at, st, lt, ct = function() {
			...
			(!xt || o && o !== r.currItem) && (i /= o ? o.fitRatio : r.currItem.fitRatio),
			t[_] = y + e + "px, " + n + "px" + b + " scale(" + i + ")"
		}, It = function(t) {
			et && (t && (m > r.currItem.fitRatio ? xt || (ln(r.currItem, !1, !0),
			xt = !0) : xt && (ln(r.currItem),
			xt = !1)),
			Pt(et, dt.x, dt.y, m))
		}, Dt = function(t) {
			...
			Rt && (o.unbind(document, "mousemove", Wt),
			...
			a.mouseUsed || o.bind(document, "mousemove", Wt),
			...
			o.unbind(document, "mousemove", Wt),
			R.transform && o.unbind(r.scrollWrap, "click", r),
			q && o.unbind(window, f, r),
			kt("unbindEvents")
		}, zt = function(t, e) {
			...
			if (_) {
				return y = "translate" + (R.perspective && !I ? "3d(" : "("),
			...
			t && ($ || X || nt || V) && (t.preventDefault(),
			t.stopPropagation())
		}, Ut = function() {
			r.setScrollOffset(0, o.getScrollY())
		}, Qt = {}, Gt = 0, Zt = function(t) {
			Qt[t] && (Qt[t].raf && O(Qt[t].raf),
			Gt--,
			delete Qt[t])
		}, Kt = function(t) {
			Qt[t] && Zt(t),
			...
			init: function() {
				if (!s && !l) {
					...
					r.currItem = Ue(u),
					(R.isOldIOSPhone || R.isOldAndroid) && (yt = !1),
					t.setAttribute("aria-hidden", "false"),
					a.modal && (yt ? t.style.position = "fixed" : (t.style.position = "absolute",
					t.style.top = o.getScrollY() + "px")),
					void 0 === M && (kt("initialLayout"),
					M = F = o.getScrollY());
					var c = "pswp--open ";
			...
			close: function() {
				...
				kt("close"),
				jt(),
				Ze(r.currItem, null, !0, r.destroy))
			},
			destroy: function() {
				kt("destroy"),
				qe && clearTimeout(qe),
			...
			panTo: function(t, e, n) {
				n || (t > tt.min.x ? t = tt.min.x : t < tt.max.x && (t = tt.max.x),
				...
				if (0 !== vt) {
					...
					if (!(t && 2 > n)) {
						...
						for (var i = 0; n > i; i++)
							...
							C[2] = e,
							d++,
							Ot((d + 2) * mt.x, e.el.style),
							r.setContent(e, u - n + i + 1 + 1)) : (e = C.pop(),
							C.unshift(e),
							d--,
							Ot(d * mt.x, e.el.style),
							r.setContent(e, u + n - i - 1 - 1));
						if (et && 1 === Math.abs(vt)) {
							var o = Ue(T);
							o.initialZoomLevel !== m && (on(o, ft),
							ln(o),
							Dt(o))
						}
						vt = 0,
			...
			updateSize: function(e) {
				...
				Ut(),
				mt.x = ft.x + Math.round(ft.x * a.spacing),
				mt.y = ft.y,
				Lt(mt.x * pt),
				kt("beforeResize"),
				void 0 !== d) {
					for (var i, s, l, c = 0; 3 > c; c++)
						i = C[c],
						Ot((c + d) * mt.x, i.el.style),
						l = u + c - 1,
						a.loop && Qe() > 2 && (l = Tt(l)),
						s = Ue(l),
						s && (x || s.needsUpdate || !s.bounds) ? (r.cleanSlide(s),
						r.setContent(i, l),
						1 === c && (r.currItem = s,
						r.updateCurrZoomItem(!0)),
						s.needsUpdate = !1) : -1 === i.index && l >= 0 && r.setContent(i, l),
						s && s.container && (on(s, ft),
						ln(s),
						Dt(s));
					x = !1
				}
			...
			zoomTo: function(t, e, n, i, r) {
				e && (v = m,
				ge.x = Math.abs(e.x) - dt.x,
				ge.y = Math.abs(e.y) - dt.y,
				Nt(ht, dt));
				var a = zt(t, !1)
				  , s = {};
				qt("x", a, s, t),
			...
			return Se.prevent = !Te(t.target, a.isClickableElement),
			kt("preventDragEvent", t, e, Se),
			Se.prevent
		}, ke = function(t, e) {
			return e.x = t.pageX,
			e.y = t.pageY,
			...
			se.forEach(function(t) {
				0 === lt ? Oe[0] = t : 1 === lt && (Oe[1] = t),
				lt++
			})) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (Oe[0] = ke(t.touches[0], Ie),
			t.touches.length > 1 && (Oe[1] = ke(t.touches[1], De))) : (Ie.x = t.pageX,
			Ie.y = t.pageY,
			Ie.id = "",
			Oe[0] = Ie),
			Oe
			...
			return n = l > tt.min[t] || l < tt.max[t] ? a.panEndFriction : 1,
			l = dt[t] + e[t] * n,
			!a.allowPanToNext && m !== r.currItem.initialZoomLevel || (et ? "h" !== it || "x" !== t || X || (c ? (l > tt.min[t] && (n = a.panEndFriction,
			tt.min[t] - l,
			i = tt.min[t] - ht[t]),
			(0 >= i || 0 > h) && Qe() > 1 ? (s = u,
			0 > h && u > le.x && (s = le.x)) : tt.min.x !== tt.max.x && (o = l)) : (l < tt.max[t] && (n = a.panEndFriction,
			l - tt.max[t],
			i = ht[t] - tt.max[t]),
			(0 >= i || h > 0) && Qe() > 1 ? (s = u,
			h > 0 && u < le.x && (s = le.x)) : tt.min.x !== tt.max.x && (o = l))) : s = u,
			"x" !== t) ? void (nt || Q || m > r.currItem.fitRatio && (dt[t] += e[t] * n)) : (void 0 !== s && (Lt(s, !0),
			Q = s !== le.x),
			tt.min.x !== tt.max.x && (void 0 !== o ? dt.x = o : Q || (dt.x += e.x * n)),
			void 0 !== s)
		}, Ne = function(t) {
			if (!("mousedown" === t.type && t.button > 0)) {
				...
				if (!B || "mousedown" !== t.type) {
					...
					Nt(ie, n[1]),
					Ae(ne, ie, me),
					ge.x = Math.abs(me.x) - dt.x,
					ge.y = Math.abs(me.y) - dt.y,
					K = J = be(ne, ie))
				}
			}
		}, Me = function(t) {
				...
				if (0 !== t)
					...
					Z && t > 1) {
						...
						if (!it)
							return;
						if (ot && (ot = !1,
						Math.abs(oe.x) >= 10 && (oe.x -= G[0].x - ae.x),
						Math.abs(oe.y) >= 10 && (oe.y -= G[0].y - ae.y)),
						re.x = ne.x,
						re.y = ne.y,
						0 === oe.x && 0 === oe.y)
							return;
			...
			$ || X || nt || V)
				...
				V) {
					var h = Pe();
					if (h < a.verticalDragRange)
						r.close();
					else {
						var d = dt.y
						  , p = at;
						te("verticalDrag", 0, 1, 300, o.easing.cubic.out, function(t) {
							dt.y = (r.currItem.initialPosition.y - d) * t + d,
							_t((1 - p) * t + p),
							It()
						}),
						kt("onVerticalDrag", 1)
					...
					if (!nt)
						return "swipe" !== s ? void Be() : void (!Q && m > r.currItem.fitRatio && je(j))
				}
		}, He = function() {
			var t, e, n = {
				lastFlickOffset: {},
				...
				calculateSwipeSpeed: function(i) {
					ce.length > 1 ? (t = At() - H + 50,
					e = ce[ce.length - 2][i]) : (t = At() - W,
					e = ae[i]),
					n.lastFlickOffset[i] = re[i] - e,
				...
				calculateOverBoundsAnimOffset: function(t, e) {
					n.backAnimStarted[t] || (dt[t] > tt.min[t] ? n.backAnimDestination[t] = tt.min[t] : dt[t] < tt.max[t] && (n.backAnimDestination[t] = tt.max[t]),
					...
					te("bounceZoomPan" + t, dt[t], n.backAnimDestination[t], e || 300, o.easing.sine.out, function(e) {
						dt[t] = e,
						It()
					}))))
				},
				...
				panAnimLoop: function() {
					...
					n.speedDecelerationRatioAbs.x < .05 && n.speedDecelerationRatioAbs.y < .05) ? (dt.x = Math.round(dt.x),
					dt.y = Math.round(dt.y),
					It(),
					void Zt("zoomPan")) : void 0
				}
			};
			return n
		}, je = function(t) {
			...
			i && (u += i,
			0 > u ? (u = a.loop ? Qe() - 1 : 0,
			c = !0) : u >= Qe() && (u = a.loop ? 0 : Qe() - 1,
			c = !0),
			(!c || a.loop) && (vt += i,
			pt -= i,
			n = !0));
			var h, d = mt.x * pt, f = Math.abs(d - pe.x);
			return n || d > pe.x == e.lastFlickSpeed.x > 0 ? (h = Math.abs(e.lastFlickSpeed.x) > 0 ? f / Math.abs(e.lastFlickSpeed.x) : 333,
			h = Math.min(h, 400),
			h = Math.max(h, 250)) : h = 333,
			he === u && (n = !1),
			nt = !0,
			kt("mainScrollAnimStart"),
			te("mainScroll", pe.x, d, h, o.easing.cubic.out, Lt, function() {
				Jt(),
				nt = !1,
				he = -1,
				(n || he !== u) && r.updateCurrItem(),
		...
		var qe, Ye, Xe, $e, Ue, Qe, Ge, Ze = function(e, n, i, s) {
			...
			var h = i ? a.hideAnimationDuration : a.showAnimationDuration
			  , d = function() {
				...
				kt("initialZoom" + (i ? "OutEnd" : "InEnd"))),
				s && s(),
				$e = !1
			};
			if (!h || !l || void 0 === l.x)
				return kt("initialZoom" + (i ? "Out" : "In")),
				m = e.initialZoomLevel,
				Nt(dt, e.initialPosition),
				It(),
			...
			!function() {
				...
				s && (i ? o[(n ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() {
					o.addClass(t, "pswp--animate_opacity")
				}, 30)),
				qe = setTimeout(function() {
					if (kt("initialZoom" + (i ? "Out" : "In")),
					i) {
						var r = l.w / e.w
						  , a = {
							x: dt.x,
						  ...
						  , f = function(e) {
							1 === e ? (m = r,
							dt.x = l.x,
							dt.y = l.y - M) : (m = (r - c) * e + c,
							dt.x = (l.x - a.x) * e + a.x,
							dt.y = (l.y - M - a.y) * e + a.y),
							It(),
							s ? t.style.opacity = 1 - e : _t(u - e * u)
						};
						n ? te("initialZoom", 0, 1, h, o.easing.cubic.out, f, d) : (f(1),
						qe = setTimeout(d, h + 20))
					} else
						m = e.initialZoomLevel,
						Nt(dt, e.initialPosition),
						It(),
			...
			i.max.y = n > Ke.y ? Math.round(Ke.y - n) + t.vGap.top : i.center.y,
			...
			if (Je.length) {
				for (var t, e = 0; e < Je.length; e++)
					t = Je[e],
					t.holder.index === t.index && rn(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
				Je = []
			}
		};
		Ct("Controller", {
			publicMethods: {
				lazyLoadItem: function(t) {
					t = Tt(t);
					var e = Ue(t);
					e && (!e.loaded && !e.loading || x) && (kt("gettingData", t, e),
					e.src && an(e))
				},
				initController: function() {
					...
					Et("mainScrollAnimComplete", cn),
					Et("initialZoomInEnd", cn),
					Et("destroy", function() {
				...
				setContent: function(t, e) {
					...
					!l.src || l.loadError || l.loaded)
						...
						if (l.loadComplete = function(n) {
							if (s) {
								if (t && t.index === e) {
									...
									n.imageAppended ? !$e && n.placeholder && (n.placeholder.style.display = "none",
									n.placeholder = null) : R.transform && (nt || $e) ? Je.push({
										item: n,
										baseDiv: c,
										img: n.img,
										index: e,
						...
						l.loading || an(l),
						r.allowProgressiveImg() && (!Xe && R.transform ? Je.push({
							item: l,
							baseDiv: c,
							img: l.img,
							index: e,
		...
		Ct("Tap", {
			publicMethods: {
				...
				onTapStart: function(t) {
					t.length > 1 && (clearTimeout(un),
					un = null)
				},
				onTapRelease: function(t, e) {
					if (e && !$ && !Y && !Gt) {
						var n = e;
						if (un && (clearTimeout(un),
						un = null,
						ye(n, hn)))
							return void kt("doubleTap", n);
						if ("mouse" === e.type)
							return void dn(t, e, "mouse");
			...
			publicMethods: {
				...
				setupDesktopZoom: function(e) {
					...
					var i, a = function() {
						...
						r.mouseZoomedIn = !1),
						1 > m ? o.addClass(t, "pswp--zoom-allowed") : o.removeClass(t, "pswp--zoom-allowed"),
						s()
					}, s = function() {
				...
				handleMouseWheel: function(t) {
					if (m <= r.currItem.fitRatio)
						return a.modal && (!a.closeOnScroll || Gt || q ? t.preventDefault() : _ && Math.abs(t.deltaY) > 2 && (c = !0,
						r.close())),
						!0;
					if (t.stopPropagation(),
					fn.x = 0,
					"deltaX"in t)
						1 === t.deltaMode ? (fn.x = 18 * t.deltaX,
						fn.y = 18 * t.deltaY) : (fn.x = t.deltaX,
						fn.y = t.deltaY);
					else if ("wheelDelta"in t)
						t.wheelDeltaX && (fn.x = -.16 * t.wheelDeltaX),
						t.wheelDeltaY ? fn.y = -.16 * t.wheelDeltaY : fn.y = -.16 * t.wheelDelta;
					else {
						if (!("detail"in t))
							return;
						fn.y = t.detail
					...
					var e = dt.x - fn.x
					  , n = dt.y - fn.y;
					(a.modal || e <= tt.min.x && e >= tt.max.x && n <= tt.min.y && n >= tt.max.y) && t.preventDefault(),
					r.panTo(e, n)
				},
		...
		var pn, gn, mn, vn, yn, bn, wn, xn, Cn, Tn, Sn, En, kn = {
			...
			Gt || q)
				return void (mn = setTimeout(In, 500));
			...
			En ? "#" + n !== window.location.hash && history[xn ? "replaceState" : "pushState"]("", document.title, i) : xn ? Sn.replace(i) : Sn.hash = n,
			xn = !0,
			...
			publicMethods: {
				initHistory: function() {
					...
					a.history) {
						...
						wn.indexOf("gid=") > -1 && (wn = wn.split("&gid=")[0],
						wn = wn.split("?gid=")[0]),
						...
						var t = function() {
							bn = !0,
							Cn || (Tn ? history.back() : wn ? Sn.hash = wn : En ? history.pushState("", document.title, Sn.pathname + Sn.search) : Sn.hash = ""),
							_n()
						};
						Et("unbindEvents", function() {
							c && t()
						...
						e > -1 && (wn = wn.substring(0, e),
						"&" === wn.slice(-1) && (wn = wn.slice(0, -1))),
						setTimeout(function() {
				...
				onHashChange: function() {
					return An() === wn ? (Cn = !0,
					void r.close()) : void (vn || (yn = !0,
					r.goTo(Pn().pid),
					yn = !1))
				},
				updateURL: function() {
					_n(),
					yn || (xn ? pn = setTimeout(In, 800) : In())
				}
			}
		}),
		o.extend(r, ee)
	...
	return function(t, e) {
		var n, i, o, r, a, s, l, c, u, h, d, f, p, g, m, v, y, b, w, x = this, C = !1, T = !0, S = !0, E = {
			...
			if (v)
				return !0;
			t = t || window.event,
			m.timeToIdle && m.mouseUsed && !u && M();
			for (var n, i, o = t.target || t.srcElement, r = o.getAttribute("class") || "", a = 0; a < q.length; a++)
				n = q[a],
			...
			for (var t, e, n, i, o, r = "", a = 0; a < m.shareButtons.length; a++)
				t = m.shareButtons[a],
				n = m.getImageURLForShare(t),
				i = m.getPageURLForShare(t),
				o = m.getTextForShare(t),
				...
				m.parseShareButtonOut && (r = m.parseShareButtonOut(t, r));
			l.children[0].innerHTML = r,
			l.children[0].onclick = O
		}, F = function(t) {
			for (var n = 0; n < m.closeElClasses.length; n++)
				if (e.hasClass(t, "pswp__" + m.closeElClasses[n]))
					return !0
		}, N = 0, M = function() {
			clearTimeout(w),
			N = 0,
			...
			m.fullscreenEl && !e.features.isOldAndroid && (n || (n = x.getFullscreenAPI()),
			n ? (e.bind(document, n.eventK, x.updateFullscreen),
			x.updateFullscreen(),
			...
			h("onPinchClose", function(e) {
				T && .9 > e ? (x.hideControls(),
				t = !0) : t && !T && e > .9 && x.showControls()
			}),
				...
				if (i)
					for (var r = i.length, a = 0; r > a; a++) {
						...
						for (var s = 0; s < q.length; s++)
							o = q[s],
							n.indexOf("pswp__" + o.name) > -1 && (m[o.option] ? (e.removeClass(t, "pswp__element--disabled"),
		...
		x.init = function() {
			...
			h("unbindEvents", function() {
				...
				n && (e.unbind(document, n.eventK, x.updateFullscreen),
				n.isFullscreen() && (m.hideAnimationDuration = 0,
				n.exit()),
				n = null)
			}),
			h("destroy", function() {
				m.captionEl && (r && i.removeChild(r),
		...
		,
		x.update = function() {
			T && t.currItem ? (x.updateIndexIndicator(),
			m.captionEl && (m.addCaptionHTMLFn(t.currItem, o),
			_(o, "caption--empty", !t.currItem.title)),
			C = !0) : C = !1,
			S || D(),
			P()
		}
		...
		x.onGlobalTap = function(n) {
			...
			if (!v)
				...
				m.tapToClose && (e.hasClass(i, "pswp__img") || F(i)))
					return void t.close()
		}
		,
		x.onMouseOver = function(t) {
			t = t || window.event,
			_(i, "ui--over-close", F(t.target || t.srcElement))
		}
		,
...
var initPhotoSwipeFromDOM = function(t) {
	for (var e = function(t) {
		for (var e, n, i, o, r = t.childNodes, a = r.length, s = [], l = 0; l < a; l++)
			e = r[l],
		...
		r.init())
	}, r = document.querySelectorAll(t), a = 0, s = r.length; a < s; a++)
		r[a].setAttribute("data-pswp-uid", a + 1),
		r[a].onclick = i;
	var l = function() {
...
function(t) {
	t.fn.sticky = function(e) {
		...
		return this.each(function() {
			function e() {
				var e = f.scrollTop();
				if (r && "string" == typeof d)
					var i = t(d).offset().top
					  , s = i - a - l;
				else if (r && "number" == typeof d)
					var s = d;
				if (u < e) {
					if (n.after(h).css({
						position: "fixed",
...
function t(e, n, i) {
	...
	4: [function(t, e, n) {
		...
		i.prototype.unbind = function(t, e) {
			...
			this.events[t] = this.events[t].filter(function(i) {
				return !(!n || i === e) || (this.element.removeEventListener(t, i, !1),
				!1)
			}, this)
		}
		,
	...
	6: [function(t, e, n) {
		...
		n.startScrolling = function(t, e) {
			...
			void 0 !== e ? i.add(t, "ps-" + e) : (i.add(t, "ps-x"),
			i.add(t, "ps-y"))
		}
		,
		n.stopScrolling = function(t, e) {
			i.remove(t, "ps-in-scrolling"),
			void 0 !== e ? i.remove(t, "ps-" + e) : (i.remove(t, "ps-x"),
			i.remove(t, "ps-y"))
		}
		,
		n.env = {
	...
	10: [function(t, e, n) {
		...
		function i(t, e) {
			...
			e.event.bind(e.scrollbarYRail, "click", function(i) {
				...
				a(t, "top", t.scrollTop + s * e.containerHeight),
				r(t),
				i.stopPropagation()
			}),
			...
			e.event.bind(e.scrollbarXRail, "click", function(i) {
				...
				a(t, "left", t.scrollLeft + s * e.containerWidth),
				r(t),
				i.stopPropagation()
			})
		}
	...
	11: [function(t, e, n) {
		...
		function i(t, e) {
			function n(n) {
				...
				c(t, "left", r.toInt(e.scrollbarXLeft * (e.contentWidth - e.containerWidth) / (e.containerWidth - e.railXRatio * e.scrollbarXWidth)) - e.negativeScrollAdjustment)
			}
			var i = null
			  , o = null
			  , s = function(e) {
			...
			e.event.bind(e.scrollbarX, "mousedown", function(n) {
				o = n.pageX,
				i = r.toInt(a.css(e.scrollbarX, "left")) * e.railXRatio,
		...
		function o(t, e) {
			function n(n) {
				...
				c(t, "top", r.toInt(e.scrollbarYTop * (e.contentHeight - e.containerHeight) / (e.containerHeight - e.railYRatio * e.scrollbarYHeight)))
			}
			var i = null
			  , o = null
			  , s = function(e) {
			...
			e.event.bind(e.scrollbarY, "mousedown", function(n) {
				o = n.pageY,
				i = r.toInt(a.css(e.scrollbarY, "top")) * e.railYRatio,
		...
		function i(t, e) {
			...
			function s(s) {
				var c = i(s)
				  ...
				  , h = c[1];
				o(u, h) || (l = !1,
				e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (h ? a(t, "top", t.scrollTop - h * e.settings.wheelSpeed) : a(t, "top", t.scrollTop + u * e.settings.wheelSpeed),
				l = !0) : e.scrollbarXActive && !e.scrollbarYActive && (u ? a(t, "left", t.scrollLeft + u * e.settings.wheelSpeed) : a(t, "left", t.scrollLeft - h * e.settings.wheelSpeed),
				l = !0) : (a(t, "top", t.scrollTop - h * e.settings.wheelSpeed),
				a(t, "left", t.scrollLeft + u * e.settings.wheelSpeed)),
				r(t),
		...
		function i(t, e) {
			...
			e.event.bind(window, "mousemove", function(e) {
				if (h) {
					...
					n.x < r.left + 3 ? (u.left = -5,
					o.startScrolling(t, "x")) : n.x > r.right - 3 ? (u.left = 5,
					o.startScrolling(t, "x")) : u.left = 0,
					n.y < r.top + 3 ? (r.top + 3 - n.y < 5 ? u.top = -5 : u.top = -20,
					o.startScrolling(t, "y")) : n.y > r.bottom - 3 ? (n.y - r.bottom + 3 < 5 ? u.top = 5 : u.top = 20,
	...
	16: [function(t, e, n) {
		...
		function i(t, e, n, i) {
			function o(n, i) {
				...
				} else if (a > s && (n < 0 && r === e.contentWidth - e.containerWidth || n > 0 && 0 === r))
					return !e.settings.swipePropagation;
				return !0
			}
			function l(e, n) {
			...
			function p(t) {
				if (!x && e.settings.swipePropagation && f(t),
				!w && x && d(t)) {
					var n = h(t)
					  , i = {
						pageX: n.pageX,
			...
			function g() {
				...
				clearInterval(b),
				b = setInterval(function() {
					return r.get(t) && (y.x || y.y) ? Math.abs(y.x) < .01 && Math.abs(y.y) < .01 ? void clearInterval(b) : (l(30 * y.x, 30 * y.y),
					y.x *= .8,
			...
			e.event.bind(t, "touchend", g)) : i && (window.PointerEvent ? (e.event.bind(window, "pointerdown", c),
	...
	18: [function(t, e, n) {
		...
		function i(t) {
			...
			i.scrollbarXRail = u.appendTo(u.e("div", "ps-scrollbar-x-rail"), t),
			...
			i.railXWidth = null,
			i.railXRatio = null,
			i.scrollbarYRail = u.appendTo(u.e("div", "ps-scrollbar-y-rail"), t),
	...
	19: [function(t, e, n) {
		...
		e.exports = function(t) {
			...
			e.scrollbarXWidth = i(e, r.toInt(e.railXWidth * e.containerWidth / e.contentWidth)),
			e.scrollbarXLeft = r.toInt((e.negativeScrollAdjustment + t.scrollLeft) * (e.railXWidth - e.scrollbarXWidth) / (e.contentWidth - e.containerWidth))) : e.scrollbarXActive = !1,
			...
			e.scrollbarYHeight = i(e, r.toInt(e.railYHeight * e.containerHeight / e.contentHeight)),
			e.scrollbarYTop = r.toInt(t.scrollTop * (e.railYHeight - e.scrollbarYHeight) / (e.contentHeight - e.containerHeight))) : e.scrollbarYActive = !1,
			...
			o(t, e),
			e.scrollbarXActive ? a.add(t, "ps-active-x") : (a.remove(t, "ps-active-x"),
			e.scrollbarXWidth = 0,
			e.scrollbarXLeft = 0,
			c(t, "left", 0)),
			e.scrollbarYActive ? a.add(t, "ps-active-y") : (a.remove(t, "ps-active-y"),
	...
	20: [function(t, e, n) {
		...
		e.exports = function(t, e, n) {
			...
			i || (i = t.scrollTop),
			o || (o = t.scrollLeft),
			"top" === e && n < i && t.dispatchEvent(a("ps-scroll-up")),
...
function(t) {
	...
	t.fn.material_chip = function(i) {
		...
		"data" === i ? this.$el.data("chips") : "options" === i ? this.$el.data("options") : (this.$el.data("options", t.extend({}, n, i)),
		this.init = function() {
			var e = 0;
			o.$el.each(function() {
				var n = t(this);
		...
		this.handleEvents = function() {
				...
				if (!t(n.target).is("input, textarea")) {
					...
					if (r.length)
						if (8 === n.which || 46 === n.which) {
							...
							o.deleteChip(l, i, a);
							var c = null;
							i + 1 < s ? c = i : i !== s && i + 1 !== s || (c = s - 1),
							c < 0 && (c = null),
							null !== c && o.selectChip(l, c, a),
			...
			o.$document.on("keydown", e.CHIPS + " " + e.INPUT, function(n) {
				...
				return 13 === n.which ? (n.preventDefault(),
				o.addChip(a, {
					tag: i.val()
				}, r),
				void i.val("")) : 8 !== n.keyCode && 37 !== n.keyCode || "" !== i.val() || !s ? void 0 : (o.selectChip(a, s - 1, r),
				void i.blur())
			}),
		...
		this.addChip = function(e, n, i) {
			if (o.isValid(i, n)) {
				var r = (i.data("options"),
				o.renderChip(n));
				i.data("chips").push(n),
				t(r).insertBefore(i.find("input")),
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}
  , Prism = function() {
	  ...
	  , n = _self.Prism = {
		...
		languages: {
			...
			DFS: function(t, e, i, o) {
				o = o || {};
				for (var r in t)
					t.hasOwnProperty(r) && (e.call(t, r, t[r], i || r),
					"Object" !== n.util.type(t[r]) || o[n.util.objId(t[r])] ? "Array" !== n.util.type(t[r]) || o[n.util.objId(t[r])] || (o[n.util.objId(t[r])] = !0,
					n.languages.DFS(t[r], e, r, o)) : (o[n.util.objId(t[r])] = !0,
					n.languages.DFS(t[r], e, null, o)))
			}
		},
		plugins: {},
		...
		highlightElement: function(e, i, o) {
			...
			if (n.hooks.run("before-highlight", c),
			i && _self.Worker) {
							...
							if (!(m instanceof i)) {
								...
								if (!v && d && g != o.length - 1) {
									var b = o[g + 1].matchedStr || o[g + 1]
									  , w = m + b;
									if (g < o.length - 2 && (w += o[g + 2].matchedStr || o[g + 2]),
									c.lastIndex = 0,
									!(v = c.exec(w)))
										continue;
								...
								if (v) {
									...
									k.push(A),
									E && k.push(E),
									Array.prototype.splice.apply(o, k)
								}
							}
						}
					}
	...
	if (i.stringify = function(t, e, o) {
		...
		if ("comment" == r.type && (r.attributes.spellcheck = "true"),
		t.alias) {
		...
		for (var l in r.attributes)
			s += (s ? " " : "") + l + '="' + (r.attributes[l] || "") + '"';
		return "<" + r.tag + ' class="' + r.classes.join(" ") + '" ' + s + ">" + r.content + "</" + r.tag + ">"
	}
	,
	!_self.document)
		return _self.addEventListener ? (_self.addEventListener("message", function(t) {
	...
	document.addEventListener && !o.hasAttribute("data-manual") && document.addEventListener("DOMContentLoaded", n.highlightAll)),
	_self.Prism
}();
...
function() {
	self.Prism && Prism.hooks.add("after-highlight", function(t) {
		...
		if (e && /pre/i.test(e.nodeName) && -1 !== e.className.indexOf("code-toolbar")) {
			...
			if (n.setAttribute("class", "toolbar"),
...
function(t, e) {
	...
	var n, i, o, r = t, a = r.document, s = r.navigator, l = r.setTimeout, c = r.clearTimeout, u = r.setInterval, h = r.clearInterval, d = r.getComputedStyle, f = r.encodeURIComponent, p = r.ActiveXObject, g = r.Error, m = r.Number.parseInt || r.parseInt, v = r.Number.parseFloat || r.parseFloat, y = r.Number.isNaN || r.isNaN, b = r.Date.now, w = r.Object.keys, x = r.Object.defineProperty, C = r.Object.prototype.hasOwnProperty, T = r.Array.prototype.slice, S = function() {
		...
		if ("function" == typeof r.wrap && "function" == typeof r.unwrap)
			try {
		...
		if ("object" != typeof t || null == t || "number" == typeof t.nodeType)
			...
			n = 0,
			i = t.length; i > n; n++)
				C.call(t, n) && (e[n] = A(t[n]));
		else {
			e = {};
			for (o in t)
				C.call(t, o) && (e[o] = A(t[o]))
		}
		return e
	}, _ = function(t, e) {
		...
		n && n[1] ? e = n[1] : (n = t.match(/\)@((?:http[s]?|file):\/\/[\/]?.+?\/[^:\)]*?)(?::\d+)(?::\d+)?/)) && n[1] && (e = n[1])),
		e
	}, F = function() {
		var t, e;
		try {
		...
		return e && (t = e.sourceURL || e.fileName || L(e.stack)),
		t
	}, N = function() {
		var t, n, i;
		if (a.currentScript && (t = a.currentScript.src))
			return t;
		if (n = a.getElementsByTagName("script"),
		1 === n.length)
			return n[0].src || e;
		if ("readyState"in n[0])
			for (i = n.length; i--; )
				if ("interactive" === n[i].readyState && (t = n[i].src))
					return t;
		...
		var o, r, a, s = {};
		if ("string" == typeof t && t)
			a = t.toLowerCase().split(/\s+/);
		else if ("object" == typeof t && t && void 0 === i)
			for (o in t)
				C.call(t, o) && "string" == typeof o && o && "function" == typeof t[o] && Ut.on(o, t[o]);
		if (a && a.length) {
			for (o = 0,
			r = a.length; r > o; o++)
				t = a[o].replace(/^on/, ""),
		...
		if (0 === arguments.length)
			...
			for (n in t)
				C.call(t, n) && "string" == typeof n && n && "function" == typeof t[n] && Ut.off(n, t[n]);
		if (r && r.length)
			for (n = 0,
			i = r.length; i > n; n++)
				if (t = r[n].toLowerCase().replace(/^on/, ""),
				(a = z[t]) && a.length)
					if (e)
		...
		var e, n, i;
		return t = pt(t),
		t && !xt(t) ? "ready" === t.type && H.overdue === !0 ? Ut.emit({
			type: "error",
			name: "flash-overdue"
		}) : (e = k({}, t),
		bt.call(this, e),
		...
		for (var i in n)
			"string" == typeof i && i && C.call(n, i) && "string" == typeof n[i] && n[i] && (V[i] = Yt(n[i]))
	}, lt = function(t) {
		void 0 === t ? (I(V),
		B = null) : "string" == typeof t && C.call(V, t) && delete V[t]
	}, ct = function(t) {
		return void 0 === t ? A(V) : "string" == typeof t && C.call(V, t) ? V[t] : void 0
	}, ut = function(t) {
		if (t && 1 === t.nodeType) {
			i && (Rt(i, Z.activeClass),
			i !== t && Rt(i, Z.hoverClass)),
			i = t,
			Mt(t, Z.hoverClass);
			...
			Bt(Z.forceHandCursor === !0 || "pointer" === Wt(t, "cursor")),
			Vt()
		}
	}, ht = function() {
		var t = kt(H.bridge);
		...
		e) {
			e = e.toLowerCase(),
			!t.target && (/^(copy|aftercopy|_click)$/.test(e) || "error" === e && "clipboard-error" === t.name) && (t.target = o),
			k(t, {
				type: e,
			...
			"aftercopy" === t.type && (t = It(t, B)),
			t.target && !t.relatedTarget && (t.relatedTarget = gt(t.target)),
			mt(t)
		}
	}, gt = function(t) {
		...
		if ("object" == typeof t && t && t.type) {
			...
			if (o && o.length) {
				...
				s = o.length; s > a; a++)
					l = o[a],
					c = h,
					"string" == typeof l && "function" == typeof r[l] && (l = r[l]),
					"object" == typeof l && l && "function" == typeof l.handleEvent && (c = l,
					l = l.handleEvent),
					"function" == typeof l && (u = k({}, t),
					yt(l, c, [u], e))
			}
			return this
		}
		...
		var e = null;
		return (W === !1 || t && "error" === t.type && t.name && -1 !== $.indexOf(t.name)) && (e = !1),
		e
	}, xt = function(t) {
		...
		case "error":
			...
			-1 !== U.indexOf(t.name) ? k(H, {
				...
				ready: !1
			}) : "version-mismatch" === t.name && (n = t.swfVersion,
			k(H, {
				disabled: !1,
				outdated: !1,
				unavailable: !1,
		...
		case "copy":
			...
			!V["text/html"] && !V["text/plain"] && u && (c = u.value || u.outerHTML || u.innerHTML) && (l = u.value || u.textContent || u.innerText) ? (t.clipboardData.clearData(),
			t.clipboardData.setData("text/plain", l),
			c !== l && t.clipboardData.setData("text/html", c)) : !V["text/plain"] && t.target && (l = t.target.getAttribute("data-clipboard-text")) && (t.clipboardData.clearData(),
			t.clipboardData.setData("text/plain", l));
			break;
		case "aftercopy":
			Ct(t),
			Ut.clearData(),
			e && e !== Nt() && e.focus && e.focus();
			break;
		case "_mouseover":
			Ut.focus(e),
			Z.bubbleEvents === !0 && r && (e && e !== t.relatedTarget && !D(t.relatedTarget, e) && Tt(k({}, t, {
				type: "mouseenter",
				bubbles: !1,
				cancelable: !1
			})),
		...
		if (t && "string" == typeof t.type && t) {
			...
			n && i.createEvent && n.dispatchEvent && (s = [s.type, s.canBubble, s.cancelable, s.view, s.detail, s.screenX, s.screenY, s.clientX, s.clientY, s.ctrlKey, s.altKey, s.shiftKey, s.metaKey, s.button, s.relatedTarget],
			e = i.createEvent("MouseEvents"),
			e.initMouseEvent && (e.initMouseEvent.apply(e, s),
			e._source = "js",
			n.dispatchEvent(e)))
		}
	}, St = function() {
		...
		return t.id = Z.containerId,
		t.className = Z.containerClass,
		t.style.position = "absolute",
		t.style.left = "0px",
		t.style.top = "-9999px",
		t.style.width = "1px",
		t.style.height = "1px",
		t.style.zIndex = "" + qt(Z.zIndex),
		t
	}, kt = function(t) {
		...
		if (!e) {
			...
			u.innerHTML = '<object id="' + Z.swfObjectId + '" name="' + Z.swfObjectId + '" width="100%" height="100%" ' + (h ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"' : 'type="application/x-shockwave-flash" data="' + l + '"') + ">" + (h ? '<param name="movie" value="' + l + '"/>' : "") + '<param name="allowScriptAccess" value="' + i + '"/><param name="allowNetworking" value="' + o + '"/><param name="menu" value="false"/><param name="wmode" value="transparent"/><param name="flashvars" value="' + s + '"/><div id="' + Z.swfObjectId + '_fallbackContent">&nbsp;</div></object>',
			e = u.firstChild,
			u = null,
			S(e).ZeroClipboard = Ut,
			n.replaceChild(e, c),
			St()
		}
		return e || (e = a[Z.swfObjectId],
		...
		if (t) {
			var i = kt(t);
			i && ("activex" === H.pluginType && "readyState"in t ? (t.style.display = "none",
			function e() {
				if (4 === t.readyState) {
					for (var n in t)
		...
		if ("object" == typeof t && t) {
			for (var i in t)
				if (i && C.call(t, i) && "string" == typeof t[i] && t[i])
		...
		for (var i in t)
			if (C.call(t, i))
				if ("errors" === i) {
					n[i] = t[i] ? t[i].slice() : [];
					for (var o = 0, r = n[i].length; r > o; o++)
						n[i][o].format = e[n[i][o].format]
					...
					var a = t[i];
					for (var s in a)
						s && C.call(a, s) && C.call(e, s) && (n[i][e[s]] = a[s])
				}
		return n
	}, Dt = function(t, e) {
		...
		return s.length && (a += "trustedOrigins=" + f(s.join(","))),
		t.forceEnhancedClipboard === !0 && (a += (a ? "&" : "") + "forceEnhancedClipboard=true"),
		"string" == typeof t.swfObjectId && t.swfObjectId && (a += (a ? "&" : "") + "swfObjectId=" + f(t.swfObjectId)),
		"string" == typeof t.jsVersion && t.jsVersion && (a += (a ? "&" : "") + "jsVersion=" + f(t.jsVersion)),
		a
	}, Lt = function(t) {
		if (null == t || "" === t)
			return null;
		...
		t = -1 === e ? t : t.slice(e + 2);
		var n = t.indexOf("/");
		return t = -1 === n ? t : -1 === e || 0 === n ? null : t.slice(0, n),
		...
		return function(e, n) {
			...
			if (r > 0) {
				if (1 === r && "*" === o[0])
					return "always";
				if (-1 !== o.indexOf(e))
					return 1 === r && e === i ? "sameDomain" : "always"
			}
			return "never"
		}
	}(), Nt = function() {
		...
		if (/^(?:auto|inherit)$/.test(t))
			return t;
		var e;
		return "number" != typeof t || y(t) ? "string" == typeof t && (e = qt(m(t, 10))) : e = t,
		...
		function i(t) {
			t && (l = !0,
			t.version && (h = e(t.version)),
			!h && t.description && (h = e(t.description)),
			t.filename && (u = n(t.filename)))
		}
		...
		if (s.plugins && s.plugins.length)
			...
			c = !0;
			try {
				r = new t("ShockwaveFlash.ShockwaveFlash.7"),
				l = !0,
				h = e(r.GetVariable("$version"))
			} catch (n) {
				try {
					r = new t("ShockwaveFlash.ShockwaveFlash.6"),
					l = !0,
					h = "6.0.21"
				} catch (n) {
					try {
						r = new t("ShockwaveFlash.ShockwaveFlash"),
						l = !0,
						h = e(r.GetVariable("$version"))
					} catch (t) {
						c = !1
	...
	var te = function(t) {
	  ...
	  , ee = function(t, i) {
		...
		if ("string" == typeof t && t)
			...
			for (o in t)
				C.call(t, o) && "string" == typeof o && o && "function" == typeof t[o] && this.on(o, t[o]);
		if (a && a.length) {
			for (o = 0,
			r = a.length; r > o; o++)
				t = a[o].replace(/^on/, ""),
	  ...
	  , ne = function(t, e) {
		...
		if (0 === arguments.length)
			...
			for (n in t)
				C.call(t, n) && "string" == typeof n && n && "function" == typeof t[n] && this.off(n, t[n]);
		if (r && r.length)
			for (n = 0,
			i = r.length; i > n; n++)
				if (t = r[n].toLowerCase().replace(/^on/, ""),
	  ...
	  , ie = function(t) {
		...
		return n && (e = "string" == typeof t && t ? n[t] ? n[t].slice(0) : [] : A(n)),
		e
	}
	  , oe = function(t) {
		if (ce.call(this, t)) {
	  ...
	  , re = function(t) {
		...
		for (var e = 0; e < t.length; e++)
			if (C.call(t, e) && t[e] && 1 === t[e].nodeType) {
				t[e].zcClippingId ? -1 === Kt[t[e].zcClippingId].indexOf(this.id) && Kt[t[e].zcClippingId].push(this.id) : (t[e].zcClippingId = "zcClippingId_" + Zt++,
				Kt[t[e].zcClippingId] = [this.id],
				Z.autoActivate === !0 && de(t[e]));
	  ...
	  , ae = function(t) {
		...
		for (var o = t.length; o--; )
			if (C.call(t, o) && t[o] && 1 === t[o].nodeType) {
				for (n = 0; -1 !== (n = i.indexOf(t[o], n)); )
					i.splice(n, 1);
				var r = Kt[t[o].zcClippingId];
				if (r) {
					for (n = 0; -1 !== (n = r.indexOf(this.id, n)); )
						r.splice(n, 1);
					0 === r.length && (Z.autoActivate === !0 && fe(t[o]),
		...
		if ("object" == typeof t && t && t.type && e) {
			...
			if (a && a.length) {
				...
				l = a.length; l > s; s++)
					c = a[s],
					u = d,
					"string" == typeof c && "function" == typeof r[c] && (c = r[c]),
					"object" == typeof c && c && "function" == typeof c.handleEvent && (u = c,
					c = c.handleEvent),
					"function" == typeof c && (h = k({}, t),
					yt(c, u, [h], n))
			}
		}
	}
	  ...
	  , de = function(t) {
		if (t && 1 === t.nodeType) {
			var e = function(t) {
				(t || (t = r.event)) && ("js" !== t._source && (t.stopImmediatePropagation(),
				t.preventDefault()),
				delete t._source)
			}
			  , n = function(n) {
	  ...
	  , fe = function(t) {
		if (t && 1 === t.nodeType) {
			...
			if ("object" == typeof e && e) {
				for (var n, i, o = ["move", "leave", "enter", "out", "over"], r = 0, a = o.length; a > r; r++)
					n = "mouse" + o[r],
					"function" == typeof (i = e[n]) && t.removeEventListener(n, i, !1);
	...
	Ut.prototype.setText = function(t) {
		...
		return Ut.setData("text/plain", t),
		this
	}
	,
	...
	Ut.prototype.setRichText = function(t) {
		if (!Gt[this.id])
			throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
		return Ut.setData("application/rtf", t),
		this
	}
	,
	Ut.prototype.setData = function() {
		if (!Gt[this.id])
			throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
		return Ut.setData.apply(this, E(arguments)),
		this
	}
	,
	Ut.prototype.clearData = function() {
		...
		return Ut.clearData.apply(this, E(arguments)),
		this
	}
	,
	...
	t.extend(t.validator, {
		...
		prototype: {
			...
			element: function(e) {
				...
				o = this.check(i) !== !1,
				o ? delete this.invalid[i.name] : this.invalid[i.name] = !0),
			...
			elements: function() {
				...
				return t(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, [disabled]").not(this.settings.ignore).filter(function() {
					...
					!(this.name in n || !e.objectLength(t(this).rules())) && (n[this.name] = !0,
					!0)
				})
			},
			clean: function(e) {
			...
			elementValue: function(e) {
				...
				return "radio" === o || "checkbox" === o ? t("input[name='" + i.attr("name") + "']:checked").val() : (n = i.val(),
			...
			showLabel: function(e, n) {
				...
				i.html(n)) : (i = t("<" + this.settings.errorElement + ">").attr("for", this.idOrName(e)).addClass(this.settings.errorClass).html(n || ""),
				...
				"string" == typeof this.settings.success ? i.addClass(this.settings.success) : this.settings.success(i, e)),
		...
		dataRules: function(e) {
			var n, i, o = {}, r = t(e);
			for (n in t.validator.methods)
				void 0 !== (i = r.data("rule" + n[0].toUpperCase() + n.substring(1).toLowerCase())) && (o[n] = i);
			return o
		},
		...
		normalizeRules: function(e, n) {
			...
			t.each(["rangelength", "range"], function() {
				var n;
				e[this] && (t.isArray(e[this]) ? e[this] = [Number(e[this][0]), Number(e[this][1])] : "string" == typeof e[this] && (n = e[this].split(/[\s,]+/),
			...
			remote: function(e, n, i) {
				...
				t.ajax(t.extend(!0, {
					...
					success: function(i) {
						...
						o.showErrors()) : (r = {},
						s = i || o.defaultMessage(n, "remote"),
						r[n.name] = a.message = t.isFunction(s) ? s(e) : s,
						o.invalid[n.name] = !0,
						o.showErrors(r)),
						a.valid = c,
						o.stopRequest(n, c)
